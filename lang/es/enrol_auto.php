...
/**
 * Strings for component 'enrol_auto', language 'es', version '4.2'.
 *
 * @package     enrol_auto
 * @category    string
...
$string['auto:unenrol'] = 'Des-inscribir (dar de baja) usuarios del curso';
$string['auto:unenrolself'] = 'Des-inscribirse (darse de baja) a sí mismo del curso';
