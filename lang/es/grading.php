...
/**
 * Strings for component 'grading', language 'es', version '4.2'.
 *
 * @package     grading
 * @category    string
...
$string['formnotavailable'] = 'Se ha seleccionado un método de calificación avanzada, pero el formulario de calificación aún no está disponible.';
