...
/**
 * Strings for component 'skype', language 'es', version '4.2'.
 *
 * @package     skype
 * @category    string
...
$string['skypeopen'] = 'Este Skype abrirá en {$a}.';
$string['skypeopentime'] = 'Hora de apertura';
...
$string['withselected'] = 'Con Seleccionado (mediante casillas de verificación):';
