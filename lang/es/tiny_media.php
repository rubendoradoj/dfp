...
/**
 * Strings for component 'tiny_media', language 'es', version '4.2'.
 *
 * @package     tiny_media
 * @category    string
...
$string['addcaptionstrack'] = 'Añadir pista de letreritos';
...
$string['captions_help'] = 'Los letreritos pueden ser usados para describir todo lo que pasa en la pista, incluyendo sonidos no-verbales como por ejemplo un teléfono sonando:';
$string['captionssourcelabel'] = 'URL de pista de letreritos';
...
$string['mute'] = 'Mudo';
$string['pluginname'] = 'Insertar medio pequeño';
...
$string['tracks'] = 'Subtítulos y letreritos';
$string['tracks_help'] = 'Subtítulos, letreritos, capítulos y descripciones pueden ser añadidos vía un archivo con formato WebVTT (Web Video Text Tracks). Las etiquetas de la pista serán mostradas en el menú desplegable para seleccionar. Para cada tipo de pista, cualquier pista configurada como predeterminada será pre-seleccionada al inicio del cideo.';
