...
/**
 * Strings for component 'backup', language 'es', version '4.2'.
 *
 * @package     backup
 * @category    string
...
$string['configgeneralcompetencies'] = 'Establece el valor predeterminado para la inclusión de las competencias en una copia de seguridad.';
...
$string['configgeneralpermissions'] = 'Si se habilita, los permisos del rol serán importados. Esto puede anular permisos existentes para usuarios inscritos.';
...
$string['configgeneralxapistate'] = 'Establece el valor predeterminado para incluir el estado del usuario en contenido como actividades H5P en una copia de seguridad.';
...
$string['configrestorepermissions'] = 'Si se habilita, los permisos del rol serán restaurados. Esto puede anular permisos existentes para usuarios inscritos.';
...
$string['configrestorexapistate'] = 'Establece el valor predeterminado para restaurar el estado del usuario en contenido como actividades H5P.';
...
$string['generalpermissions'] = 'Incluir anulaciones de permisos';
...
$string['generalxapistate'] = 'Incluir estado de usuario en contenido como actividades H5P';
...
$string['rootsettingpermissions'] = 'Incluir anulaciones de permisos';
