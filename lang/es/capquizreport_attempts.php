...
/**
 * Strings for component 'capquizreport_attempts', language 'es', version '4.2'.
 *
...
$string['attemptsfilename'] = 'intentos';
$string['correct'] = 'Correcto';
$string['false'] = 'Falso';
$string['pluginname'] = 'Intentos';
...
$string['questionprevrating'] = 'Valoración previa de la pregunta';
$string['questionprevratingmanual'] = 'Valoración previa actualizada manualmente';
$string['rating_manually_updated'] = 'La valoración previa fue actualizada manualmente';
...
$string['userprevrating'] = 'Valoración previa del usuario';
