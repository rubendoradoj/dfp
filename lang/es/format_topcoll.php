...
/**
 * Strings for component 'format_topcoll', language 'es', version '4.2'.
 *
...
$string['defaultdisplayblocksloc'] = 'Localización del bloque a mostrar';
$string['defaultdisplayblocksloc_desc'] = 'Elegir la localización para los bloques elegidos arriba para mostrarse, pre(vio) o post(erior) respecto al lado.';
...
$string['informationsettingsdesc'] = 'Información del formato de Tópicos Colapsados';
...
$string['settingssettingsdesc'] = 'Configuraciones del formato de Tópicos Colapsados';
