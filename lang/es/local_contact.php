...
/**
 * Strings for component 'local_contact', language 'es', version '4.2'.
 *
...
$string['confirmationmessage'] = 'Gracias por contactar con nosotros. Si es necesario nos pondremos en contacto contigo muy pronto.';
