...
/**
 * Strings for component 'simplelesson', language 'es', version '4.2'.
 *
...
$string['actions'] = 'Acciones de Página';
...
$string['add_question_help'] = 'Seleccionar una pregunta para añadir a la página; el tipo de pregunta es mostrado entre paréntesis. Use el enlace para Previsualizar pregunta para ver y probar la pregunta tal como aparecerá en la página. Configure un puntaje conforme se necesite. Las preguntas que ya han sido añadidas a la LecciónSimple están deshabilitadas. Para cancelar, use el botón para regresar o Envío sin pregunta seleccionada (en cualquier caso usted puede eliminar fácilmente una pregunta de una página).';
$string['allocate_mark'] = 'Asignar un puntaje para el ensayo';
$string['allowincomplete'] = 'Permitir intentos incompletos de pregunta';
$string['allowincomplete_help'] = 'Desactivar para forzar a los estudiantes a que respondan a una pregunta antes de que sean mostrados los enlaces de navegación.';
...
$string['bad_question'] = 'Duplicada o sin pregunta seleccionada';
$string['basic_report'] = 'Reporte básico';
$string['behaviour'] = 'Comportamiento de pregunta';
$string['behaviour_help'] = 'Con retroalimentación Adaptativa el usuario tiene intentos múltiples para cada pregunta - puede aplicarse un castigo a menos que se use Adaptativa sin castigo. Esto solamente puede configurarse para la lección, no para cada pregunta. La retroalimentación inmediata tiene un intento disponible. Para retroalimentación diferida la respuesta debe ser guardada explícitamente, pero están permitidos guardados múltiple; el estudiante solamente ve el puntaje cuando revisa la lección.';
$string['cancelled'] = 'Acción cancelada';
$string['category_select'] = 'Sleccionar categoría';
$string['categoryid'] = 'Categoría';
$string['categoryid_help'] = 'Elija una categoría para las preguntas que pueden ser añadidas a la lecciónsimple. Usted puede usar el Buscar en el enlace al banco para manipular el banco de preguntas para este curso/actividad.';
...
$string['confirm_delete'] = 'Usted está a punto de eliminar una página de esta lección. Esta acción no puede deshacerse.';
$string['date'] = 'Fecha del intento';
$string['deferredcbm'] = 'Retroalimentación diferida con PBC';
$string['deferredfeedback'] = 'Retroalimentación diferida';
$string['delete'] = 'eliminar';
$string['delete_page'] = 'Eliminar página: {$a}';
$string['delete_page_button'] = 'Eliminar página';
$string['delete_question'] = 'Eliminar pregunta';
$string['deleteallattempts'] = 'Eliminar todos los intentos.';
$string['deleteallsubmissions'] = 'Eliminar todos los envíos';
$string['edit_lesson'] = 'Editar lección';
...
$string['graderinfo'] = 'Información para calificador (si hubiera)';
$string['hasquestion'] = 'Pregunta';
$string['home'] = 'Inicio';
$string['id'] = 'ID';
...
$string['lackpages'] = 'Se necesitan al menos 2 páginas para gestionar';
...
$string['manage_pages_here'] = 'Gestionar esta página';
$string['manage_questions'] = 'Gestionar preguntas';
$string['managelesson'] = 'Gestionar Lección:';
...
$string['nextid'] = 'Siguiente id';
$string['nextpage'] = 'Página siguiente';
$string['no_manual_grades'] = 'Nada para calificar';
$string['no_pages'] = 'No hay páginas en esta Lección Simple';
$string['no_question'] = 'No se encontraron preguntas';
$string['no_questions'] = 'No hay preguntas para intentar (usar vista previa)';
$string['none'] = 'ninguna';
$string['noquestions'] = 'No hay preguntas; seleccione ua categoría desde Gestionar preguntas en la pantalla de Editar Lección Simple.';
$string['num_pages'] = 'Número de páginas: {$a}';
$string['numattempts'] = 'Intentos hechos: {$a} de';
$string['outof'] = 'De un total de';
$string['outofsequence'] = 'Algo falló con el motor de preguntas; por favor inténtelo nuevamente';
$string['page_adding'] = 'Añadir una nueva página';
$string['page_created'] = 'Nueva página creada';
$string['page_deleted'] = 'Página eliminada';
$string['page_editing'] = 'Use esta página para organizar su Lección simple. Usted puede editar, ver, eliminar y mover páginas desde aquí (use los íconos debajo de Acciones). Autosecuenciación pondrá los números de secuencia en un orden lógico.';
$string['page_index_header'] = 'Índice';
$string['page_saved'] = 'Página guardada';
$string['page_updated'] = 'Página actualizada';
$string['pagecontents'] = 'Contenido de página';
$string['pagetitle'] = 'Título';
$string['pageviewed'] = 'Página de lección simple vista';
$string['pluginadministration'] = 'Administración de Lección simple';
$string['pluginname'] = 'Lección simple';
$string['prev'] = 'Anterior';
$string['previd'] = 'ID anterior';
$string['preview'] = 'Vista previa';
$string['preview_completed'] = 'vista previa completada';
$string['preview_question'] = 'Previsualizar pregunta';
$string['prevpage'] = 'Página anterior';
$string['privacy:metadata:simplelesson_answers'] = 'Información acerca de los intentos de usuarios en Lecciónsimple para las preguntas individuales, incluyendo sus respuestas y un puntaje.';
...
$string['privacy:metadata:simplelesson_attempts'] = 'Información acerca de los intentos de usuarios de Lección Simple, incluyendo su estado de finalización, el número de respuestas correctas (un puntaje) y el tiempo empleado (segundos) para el intento.';
...
$string['qlink'] = 'Buscar';
$string['qlinkheader'] = 'Buscar en banco';
$string['qnumber'] = 'Pregunta número';
$string['question'] = 'Pregunta';
$string['question_added'] = 'Pregunta añadida';
$string['question_adding'] = 'Seleccionar una categoría y un comportamiento para preguntas. Usted puede usar preguntas de más de una categoría al regresar aquí y seleccionar otra. El comportamiento seleccionado aplica para todas las preguntas en la Lección Simple.';
$string['question_deleted'] = 'Pregunta eliminada';
$string['question_editing'] = 'Editando preguntas';
$string['question_name'] = 'Nombre de la pregunta';
$string['question_placeholder'] = '[[No hay preguntas en esta página]]';
$string['question_text'] = 'Texto de la pregunta';
$string['question_version'] = 'Versión de pregunta';
$string['questions_added'] = 'Preguntas añadidas';
$string['questionscore'] = 'Puntaje';
$string['questionscore_help'] = 'Opcionalmente escribir un puntaje para esta pregunta (predeterminado = 1)';
$string['questionsummary'] = 'Pregunta';
$string['remove'] = 'Quitar';
$string['reportsheader'] = 'Seleccionar reporte requerido; hacer clic en pestaña de reportes para regresar al menú.';
$string['reportspage'] = 'Reportes disponibles';
$string['reportstab'] = 'reportes';
$string['requires_grading'] = 'Necesita calificación';
$string['rightanswer'] = 'Respuesta correcta';
$string['save_message'] = 'IMPORTANTE: Guarde su respuesta antes de ir a la página siguiente. Usted puede editar y guardar nuevamente si cambia de opinión.';
$string['saveanswer'] = 'Guardar respuesta';
$string['saveessay'] = 'Guardar ensayo';
$string['select_category'] = 'Seleccionar categoría';
$string['select_question'] = 'Seleccionar pregunta';
$string['select_sort'] = 'Seleccionar columna para ordenamiento';
$string['sequence'] = 'Secuencia';
...
$string['the_essay'] = 'El ensayo a calificar';
$string['timecreated'] = 'Hora de creación';
$string['timetaken'] = 'Tiempo (s) usado(s)';
