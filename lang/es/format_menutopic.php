...
/**
 * Strings for component 'format_menutopic', language 'es', version '4.2'.
 *
...
$string['aboutsection'] = 'Información de la sección';
...
$string['coursedisplay_help'] = 'Esto define como visualización la sección 0, como un elemento del menú o como seccción antes de la barra del menú.';
$string['coursedisplay_multi'] = 'Antes del menú';
$string['coursedisplay_single'] = 'Como un elemento del menú';
...
$string['defaultsectionsnavigation'] = 'Valor por defecto para la navegación entre secciones';
$string['defaultsectionsnavigation_help'] = 'Valor por defecto usado en los cursos para la funcionalidad de "Usar navegación entre secciones". Este valor puede ser sobrescrito por cada curso.';
...
$string['enableanchorposition_help'] = 'Usar un ancla para navegar a la parte inicial del menú cuando se navega mediante una opción del menú.';
...
$string['globalstyle_help'] = 'Define la apariencia que tendrá el menú.';
$string['hiddenmenubar'] = 'El menú está configurado como oculto por lo que no estará visible cuando no esté en modo edición.';
...
$string['navigationposition_site'] = 'Use el valor por defecto del sitio';
$string['navigationposition_slide'] = 'Como diapositivas';
$string['navigationposition_support'] = 'Solamente si el tema no soporta el "Índice de curso"';
...
$string['privacy:metadata'] = 'El plugin del formato Menutopic no almacena ningún dato personal.';
...
$string['shownavbarbrand'] = 'Mostrar la marca';
$string['shownavbarbrand_help'] = 'Mostrar el texto de la marca en la barra de navegación para los menú basados en Bootstrap.';
...
$string['tooglemenu'] = 'Alternar menú';
...
$string['usescourseindex_help'] = 'Usar el <em>índice de curso</em> para navegar a través de las secciones y recursos.';
$string['usessectionsnavigation'] = 'Usar navegación entre secciones';
$string['usessectionsnavigation_help'] = 'Mostrar botones para navegar a secciones anteriores y siguientes.';
