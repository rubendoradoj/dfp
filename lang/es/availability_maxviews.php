...
/**
 * Strings for component 'availability_maxviews', language 'es', version '4.2'.
 *
...
$string['ajaxerror'] = 'Error al conectar con el servidor';
$string['description'] = 'Impedir el acceso después de que el usuario haya visto un determinado número de veces el módulo.';
