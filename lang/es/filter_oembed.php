...
/**
 * Strings for component 'filter_oembed', language 'es', version '4.2'.
 *
...
$string['providersrestrict_desc'] = 'Restringir proveedores a una lista de proveedores permitidos';
$string['providerurl'] = 'URL del proveedor';
$string['requiredfield'] = 'El campo "{$a}" debe completarse';
