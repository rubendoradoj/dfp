...
/**
 * Strings for component 'plagiarism_unicheck', language 'es', version '4.2'.
 *
...
$string['event:file_similarity_check_recalculated'] = 'La comprobación de plagio ha sido recalculada';
...
$string['exclude_citations_help'] = 'Active esta opción para identificar y excluir Citas. Unicheck identifica Citas según las normas de las guías de APA, MLA, Chicago, Turabian, Harvard. Las Citas se resaltarán en azul. Estos valores serán excluidos del índice total de similitud.';
$string['exclude_references'] = 'Excluir Referencias';
$string['exclude_references_help'] = 'Active esta opción para identificar y excluir Referencias. Las Referencias se resaltarán en violeta. Estos valores serán excluidos del índice total de similitud.';
...
$string['privacy:metadata:plagiarism_unicheck_callback'] = 'La tabla de llamadas entrantes del servicio Unicheck';
