...
/**
 * Strings for component 'tool_brickfield', language 'es', version '4.2'.
 *
...
$string['icon:analytics-custom'] = 'Icono de analítica';
$string['icon:file-edit-custom'] = 'Editar icono de archivo';
$string['icon:hands-helping-custom'] = 'Icono de manos de ayuda';
$string['icon:search-plus-custom'] = 'Icono de búsqueda';
$string['icon:tools-custom'] = 'Icono de herramientas';
$string['icon:wand-magic-custom'] = 'Icono de varita mágica';
...
$string['newwindowphrases'] = 'nueva ventana|ventana nueva|en ventana nueva';
...
$string['warningcheckidsubject'] = 'Advertencia checkID del Kit de Accesibilidad de Brickfield';
