...
/**
 * Strings for component 'tool_unittest', language 'es', version '4.2'.
 *
...
$string['testtablescsvfileunwritable'] = 'Las tablas de prueba del fichero CSV no se puede escribir {$a->filename})';
