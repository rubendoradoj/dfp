...
/**
 * Strings for component 'block_qrcode', language 'es', version '4.2'.
 *
...
$string['img_tag_alt'] = 'Código QR';
$string['instc_uselogo'] = 'Usar logo';
$string['logofile_png'] = 'Elegir logo .png';
$string['logofile_svg'] = 'Elegir logo .svg';
$string['pluginname'] = 'Código QR';
$string['privacy:metadata'] = 'El bloque qrcode solamente muestra información acerca de un curso, pero no afecta ni almacena ningún dato personal.';
$string['qrcode:addinstance'] = 'Añadir un nuevo bloque de código QR';
