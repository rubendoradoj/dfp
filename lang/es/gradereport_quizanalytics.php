...
/**
 * Strings for component 'gradereport_quizanalytics', language 'es', version '4.2'.
 *
...
$string['challengingcategoris'] = 'Categorías Desafiantes (Para Todos los Usuarios)';
$string['challengingcategorisforme'] = 'Categorías Desafiantes para mí';
...
$string['hardestcategories'] = 'Categorías Más Difíciles';
$string['hardestcategoriespercentage'] = 'Dificultad en porcentaje (%)';
...
$string['improvementcurve'] = 'Curva de Mejoría';
...
$string['myprogress'] = 'Mi Progreso y Mis Predicciones';
...
$string['peerperformance'] = 'Desempeño de Pares';
...
$string['questioncategory'] = 'Categorías de Preguntas&#39 Análisis';
$string['questionnumber'] = 'Pregunta Número';
$string['questionpercatdes'] = 'Este gráfico indica el número de preguntas de cada categoría en el cuestionario.';
$string['questionpercategory'] = 'Pregunta Por Categoría';
$string['questionreview'] = '(Clic para Revisar Pregunta y Último Intento)';
$string['questionspercategory'] = 'Preguntas por categoria';
$string['questionstats'] = 'Puntajes#39 y Preguntas&#39 Estadísticas';
$string['quizname'] = 'Nombre del cuestionario';
$string['scorbrpercent'] = 'Puntajes por Porcentaje (Todos los Usuarios)';
...
$string['zeroattempt'] = 'Por favor intente al menos una pregunta.';
