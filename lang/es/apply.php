...
/**
 * Strings for component 'apply', language 'es', version '4.2'.
 *
 * @package     apply
 * @category    string
...
$string['add_item'] = 'Añadir elemento de entrada a la actividad';
$string['add_items'] = 'Añadir elemento de entrada a la actividad';
$string['add_pagebreak'] = 'Añadir un salto de página del que depender';
$string['adjustment'] = 'Ajuste';
$string['apply:addinstance'] = 'Añadir una nueva solicitud';
$string['apply:applies'] = 'Emitir una solicitud';
$string['apply:createprivatetemplate'] = 'Crear una plantilla privada';
$string['apply:createpublictemplate'] = 'Crear una plantilla pública';
$string['apply:deletesubmissions'] = 'Borrar envíos';
$string['apply:deletetemplate'] = 'Borrar plantilla';
$string['apply:edititems'] = 'Editar elementos';
...
$string['apply_is_already_submitted'] = 'La solicitud ya se ha enviado';
$string['apply_is_closed'] = 'El período de solicitudes está cerrado';
$string['apply_is_disable'] = 'Usted no puede usar esta Solicitud';
$string['apply_is_not_open'] = 'La solicitud no está abierta aún';
...
$string['check'] = 'Casilla de verificación';
$string['checkbox'] = 'Casillas de verificación';
...
$string['count_of_nums'] = 'Recuento de números';
...
$string['dependitem'] = 'Elemento dependiente';
...
$string['email_confirm_html'] = ': <i>\'{$a->apply}\'</i><br /><br /> Puedes verlo <a href="{$a->url}">aquí</a>.';
$string['email_confirm_text'] = ': \'{$a->apply}\'

Puedes verlo aquí:
{$a->url}';
$string['email_entry'] = 'Enviar email al solicitante';
$string['email_noreply'] = 'Este email es automático. Por favor no conteste a este email.';
$string['email_notification'] = 'Enviar notificaciones de correo electrónico al admin';
$string['email_notification_help'] = 'Si está habilitado los administradores reciben emails de notificación de los envíos de solicitudes.';
$string['email_notification_user'] = 'enviar email de notificación a los solicitantes';
...
$string['email_user_accept'] = 'Tu solicitud fue aceptada';
...
$string['email_user_reject'] = 'Tu solicitud fue rechazada';
$string['enable_deletemode'] = 'Modo de eliminación';
$string['enable_deletemode_help'] = 'Esto habilita al profesor para borrar todas las solicitudes. <br /> Por regla general establécelo en "No" por seguridad.';
$string['entries_list_title'] = 'Listado de entradas';
$string['entry_saved'] = 'Tu solicitud se ha guardado. Gracias.';
$string['entry_saved_draft'] = 'Tu solicitud se ha guardado como<strong>Borrador</strong>.';
$string['entry_saved_operation'] = 'Tu solicitud ha sido procesada.';
$string['execd_done'] = 'Terminado';
$string['execd_entry'] = 'terminado';
$string['execd_notyet'] = 'Todavía No';
...
$string['items_are_required'] = 'Se requiere una respuesta para los elementos resaltados.';
$string['label'] = 'Etiqueta';
$string['lastfirstname'] = 'apellidos nombre';
$string['maximal'] = 'máximo';
$string['messageprovider:message'] = 'Mensaje';
$string['messageprovider:processed'] = 'La operación se completó';
$string['messageprovider:submission'] = 'Operación de entrada';
$string['modulename'] = 'Formulario de solicitud';
$string['modulename_help'] = 'Puedes hacer formularios de solicitud sencillos y hacer que un usuario los envíe.';
$string['modulenameplural'] = 'Formularios de solicitud';
...
$string['multichoice'] = 'Selección múltiple';
$string['multichoice_values'] = 'Valores de selección múltiple';
$string['multichoicerated'] = 'Selección múltiple (calificada)';
$string['multichoicetype'] = 'Tipo de selección múltiple';
$string['multiple_submit'] = 'Envíos múltiples';
$string['multiple_submit_help'] = 'Si está habilitado para encuestas anónimas, los usuarios pueden enviar respuestas un número ilimitado de veces.';
$string['name'] = 'Nombre';
...
$string['no_items_available_yet'] = 'No se han creado preguntas aún';
$string['no_settings_captcha'] = 'Las opciones del CAPTCHA no pueden ser editadas.';
$string['no_submit_data'] = 'Los datos de entrada indicados no existen';
...
$string['numeric_range_to'] = 'Intervalo hasta';
...
$string['only_one_captcha_allowed'] = 'Sólo se permite un captcha en un envío';
$string['operate_is_disable'] = 'No puedes usar esta operación';
$string['operate_submit'] = 'Manejar';
$string['operate_submit_button'] = 'Procesar';
$string['operation_error_execd'] = 'Cuando no aceptas la entrada no puedes seleccionar "hecho"';
...
$string['pagebreak'] = 'Salto de página del que depender';
...
$string['pluginname'] = 'Formulario de envío';
$string['position'] = 'Posición';
$string['preview'] = 'Previsualizar';
$string['preview_help'] = 'En la vista previa puedes cambiar el orden de las preguntas.';
...
$string['submit_form_button'] = 'Nuevas solicitud';
...
$string['textfield_size'] = 'Anchura de campo de texto';
...
$string['use_one_line_for_each_value'] = '¡Usar una línea por cada valor!';
