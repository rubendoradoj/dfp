...
/**
 * Strings for component 'block_rate_course', language 'es', version '4.2'.
 *
...
$string['survey'] = '¿Cuál es el nombre de la encuesta?';
$string['survey_help'] = 'Este es el módulo de encuesta con el que se enlazará (dejar en blanco para no enlazar a la encuesta)';
$string['viewreview'] = 'Ver las respuestas a la encuesta';
