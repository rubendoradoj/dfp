...
/**
 * Strings for component 'local_checkmarkreport', language 'es', version '4.2'.
 *
...
$string['grade_useroverview_help'] = 'La calificación muestra la calificación actual dada por el profesor para cada marca de verificación.<br />Los valores en línea con los ejemplos muestran la cantidad teórica de puntos que pueden ganarse para los ejemplos seleccionados.<br />La calificación de la marca de verificación y la suma del curso de las calificaciones de marcas de verificación mostradas puede diferir de la suma de los puntos de ejemplo, debido a que los profosores den calificaciones diferentes (por ejemplo cuando los estudiantes seleccionan o no seleccionan ejemplos al principio de la lección, o si los ejemplos seleccionados no han sido resueltos correctamente).<br />La sumatoria para una marca de verificación  (en la línea "Σ marcas de verificación") muestra la calificación del profesor. Un "-" es igual a que no hay calificación actual presente.<br />La sumatoria de todas las marcas de verificación (línea "Σ total") suma todas las calificaciones de los profesores mostradas.<br />Por favor tenga en mente que estos valores se están actualizando a sí mismos de acuerdo al estado de calificación actual.';
...
$string['privacy:metadata:showattendances'] = 'Configuraciones guardadas persistentemente se muestre o no información de asistencia.';
$string['privacy:metadata:showexamples'] = 'Configuraciones guardadas persistentemente se muestren o no ejemplos.';
$string['privacy:metadata:showgrade'] = 'Configuraciones guardadas persistentemente se muestren o no calificaciones.';
$string['privacy:metadata:showpoints'] = 'Configuraciones guardadas persistentemente se muestren o no íconos/símbolos o puntos para ejemplos seleccionados.';
$string['privacy:metadata:showpresentationcounts'] = 'Configuraciones guardadas persistentemente se muestre o no la cantidad de presentaciones calificadas.';
$string['privacy:metadata:showpresentationgrades'] = 'Configuraciones guardadas persistentemente se muestren o no calificaciones de presentaciones.';
$string['privacy:metadata:signature'] = 'Configuraciones guardadas persistentemente se incluya o no un campo de firma.';
$string['privacy:metadata:sumabs'] = 'Configuraciones guardadas persistentemente se muestren o no valores absolutos.';
$string['privacy:metadata:sumrel'] = 'Configuraciones guardadas persistentemente se muestren o no valores en porcentajes.';
$string['seperatenamecolumns'] = 'Dividir nombrecompleto en columnas individuales';
$string['seperatenamecolumns_help'] = 'Si se habilita, todos los fragmentos del nombrecompleto mostrado (por ejemplo, nombre y apellidos) serán divididos en columnas individuales.';
