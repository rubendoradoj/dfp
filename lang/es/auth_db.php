...
/**
 * Strings for component 'auth_db', language 'es', version '4.2'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbpasstype'] = '<p>Especifique el formato que usa el campo de contraseña.</p> <p>Use "internal" si quiere que la base de datos externa gestione nombres de usuarios y direcciones de correo, pero que sea Moodle quien gestione contraseñas. Si usa "internal", usted debe dar un campo de dirección de correo electrónico en la base de datos externa, y debe permitir la tarea programada \\auth_db\\task\\sync_users. Moodle enviará un correo electrónico a los nuevos usuarios con una contraseña temporal.</p>';
