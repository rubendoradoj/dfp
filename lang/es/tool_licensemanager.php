...
/**
 * Strings for component 'tool_licensemanager', language 'es', version '4.2'.
 *
...
$string['deletelicenseconfirmmessage'] = 'Está seguro que desea eliminar esta licencia?';
$string['deletelicensename'] = 'Eliminar licencia \'{$a}\'';
$string['disablelicensename'] = 'Inhabilitar licencia \'{$a}\'';
...
$string['movelicensedownname'] = 'Mover la licencia \'{$a}\' hacia abajo';
$string['movelicenseupname'] = 'Mover la licencia \'{$a}\' hacia arriba';
