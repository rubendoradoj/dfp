...
/**
 * Strings for component 'format_calendar', language 'es', version '4.2'.
 *
...
$string['dayshow'] = 'Mostrar este día hasta {$a}';
...
$string['page-course-view-calendar'] = 'Cualquier página principal del curso en formato de calendario';
$string['page-course-view-calendar-x'] = 'Cualquier página del curso en formato calendario';
$string['pluginname'] = 'Formato de calendario';
$string['section0name'] = 'General';
$string['sectionname'] = 'Día';
$string['showalldays'] = 'Mostrar todos los días';
$string['showdayfromothers'] = 'Mostrar día';
$string['showfromothers'] = 'Mostrar día';
$string['showonlyday'] = 'Mostrar solo día {$a}';
