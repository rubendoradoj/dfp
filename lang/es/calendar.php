...
/**
 * Strings for component 'calendar', language 'es', version '4.2'.
 *
 * @package     calendar
 * @category    string
...
$string['colpoll'] = 'Intervalo de actualización';
...
$string['eventsdeleted'] = 'Se eliminaron {$a} eventos';
...
$string['exporthelp'] = '<p>La URL del calendario proporciona un enlace dinámico para importar eventos a otros calendarios. Cualquier evento nuevo, modificado o eliminado en el calendario de origen <strong>se verá</strong> reflejado en los otros calendarios.</p>
<p>La exportación del calendario le permite crear una copia de seguridad de los eventos, que se puede importar a otros calendarios. Las actualizaciones realizadas en el calendario de origen <strong>no</strong> se reflejarán en los otros calendarios.</p>';
