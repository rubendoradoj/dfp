...
/**
 * Strings for component 'auth_nntp', language 'es', version '4.2'.
 *
 * @package     auth_nntp
 * @category    string
...
$string['auth_nntpnotinstalled'] = 'No puede utilizar identificación NNTP. El módulo IMAP de PHP no está instalado.';
