...
/**
 * Strings for component 'block_analytics_graphs', language 'es', version '4.2'.
 *
...
$string['privacy:metadata'] = 'El bloque de Gráficos de Análisis solo muestra datos de calendario existentes.';
$string['ratio'] = 'Ratio';
