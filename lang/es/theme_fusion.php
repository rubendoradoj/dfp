...
/**
 * Strings for component 'theme_fusion', language 'es', version '4.2'.
 *
...
$string['taglinedesc'] = 'Una frase breve que se mostrará bajo el nombre del sitio en la página principal. <br />';
