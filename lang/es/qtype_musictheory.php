...
/**
 * Strings for component 'qtype_musictheory', language 'es', version '4.2'.
 *
...
$string['interval_write_questionastext'] = 'Entrada de respuesta de intervalo';
...
$string['interval_write_questionasui'] = 'Entrada de respuesta de intervalo';
...
$string['keyboard_input_questionasui'] = 'Entrada de respuesta de entrada de teclado';
...
$string['keysignature_write_questionastext'] = 'Entrada de respuesta de firma clave';
...
$string['note_write_questionastext'] = 'Entrada de respuesta de la nota';
...
$string['note_write_questionasui'] = 'Entrada de respuesta de la nota';
...
$string['qtype_keysignature-identify'] = 'Identificación de firma clave';
$string['qtype_keysignature-identify-random'] = 'Identificación de firma clave (aleatorio)';
$string['qtype_keysignature-write'] = 'Escritura de firma clave';
$string['qtype_keysignature-write-random'] = 'Escritura de firma clave (aleatorio)';
...
$string['quality-random'] = 'Posibles clases';
...
$string['questiontext_chordquality_identify'] = 'Identificar la raíz y la clase del siguiente acorde';
...
$string['questiontext_keysignature_identify_major'] = 'Determine la clave mayor representada por la siguiente firma de clave';
$string['questiontext_keysignature_identify_minor'] = 'Determine la clave menor representada por la siguiente firma de clave';
...
$string['scale_write_questionasui_help'] = '<p>Ingrese notas haciendo clic en el pentagrama, luego seleccionar el tipo de accidente en la barra de herramientas de la derecha. Para eliminar una nota, vuelva a hacer clic en ella. </p>
  <p> Tenga en cuenta que los accidentes se transfieren a notas posteriores. </p>';
$string['scaletype'] = 'Tipo de escala';
$string['scaletype-random'] = 'Posibles tipos de escala';
$string['scaletype_harmonic'] = 'Menor harmónico';
...
$string['selectaquality'] = 'Seleccione una clase';
...
$string['validation_qualitymismatch'] = 'Esta combinación de tamaño y clase de intervalo no es válida.';
