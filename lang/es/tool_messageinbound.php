...
/**
 * Strings for component 'tool_messageinbound', language 'es', version '4.2'.
 *
...
$string['messageinboundhostoauth_help'] = 'Servicio OAuth 2 a usar para acceder el servidor IMAP, usando XOAUTH2';
