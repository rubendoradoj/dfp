...
/**
 * Strings for component 'block_xp', language 'es', version '4.2'.
 *
 * @package     block_xp
 * @category    string
...
$string['defaultvisuals'] = 'Imágenes por defecto';
...
$string['enablexpgain_help'] = 'Cuando se configura como NO, nadie podrá ganar puntos de experiencia en el curso. Es útil para congelar por un tiempo los niveles o para habilitarlos durante un tiempo limitado.

Por favor, tenga en cuenta que también puede controlarse con mayor precisión usando el permiso \'block/xp:earnxp\'.';
...
$string['promointro'] = 'Conviértase en el maestro del juego y desate Level Up XP a su máximo potencial. Desbloquee características adicionales con Level Up XP+!';
...
Se mostrará un enlace al tablero de ranking completo bajo la table. Si no quiere mostrar tal enlace, añada el argumento `hidelink`.
...
Tenga en cuenta que cuando un curso usa grupos el tablero de ranking averiguará mejor de qué grupo debe mostrar el tablero de ranking.';
...
$string['visualsintro'] = 'Suba imágenes para personalizar la apariencia de los niveles.';
