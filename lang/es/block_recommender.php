...
/**
 * Strings for component 'block_recommender', language 'es', version '4.2'.
 *
...
$string['bookmark_confirmdeletionfull'] = '¿Está seguro que quiere borrar el enlace \'{$a->title}\' ({$a->url})?';
