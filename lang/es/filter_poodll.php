...
/**
 * Strings for component 'filter_poodll', language 'es', version '4.2'.
 *
...
$string['alwayshtml5'] = 'Utilizar siempre HTML5';
$string['audiotranscode'] = 'Convertir automáticamente a MP3';
$string['audiotranscodedetails'] = 'Convertir ficheros de audio grabados/subidos a formato MP3 antes de almacenarlos en Moodle. Esto funciona con grabaciones realizadas en tokyo.poodll.com o grabaciones subidas si se está usando FFMPEG';
$string['autotryports'] = 'Prueba puertos diferentes si no puede conectar';
$string['cameraback'] = 'trasera';
$string['camerafront'] = 'delantera';
$string['cancel'] = 'Cancelar';
$string['dataset'] = 'Conjunto de datos';
$string['datasetvars'] = 'Variables del conjunto de datos.';
$string['datasetvars_desc'] = 'Ponga una lista de variables separadas por coma para constituir las variables para SQL. Puede y posiblemente vaya a querer utilizar variables aquí.';
$string['default_camera'] = 'Cámara por defecto';
$string['expired'] = 'PoodLL no mostrado porque el registro ha expirado. Pregunte a su profesor/administrador para renovar el registro en PoodLL.com.';
$string['exportdiagnostics'] = 'Exportar';
$string['extensions'] = 'Extensiones de ficheros';
...
$string['filter_poodll_html5recorder_heading'] = 'Ajustes del grabador de HTML5';
$string['filter_poodll_mic_heading'] = 'Ajustes del micrófono';
$string['filter_poodll_mp3recorder_heading'] = 'Ajustes del grabador MP3';
$string['filter_poodll_network_heading'] = 'Ajustes de la red PoodLL';
$string['filter_poodll_registration_explanation'] = 'PoodLL 3 requiere una clave de registro. Si no tiene una visite Poodll.com para conseguirla.';
