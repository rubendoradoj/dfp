...
/**
 * Strings for component 'block_notifications', language 'es', version '4.2'.
 *
...
$string['rss_not_enabled'] = 'El RSS en este curso está desactivado.';
$string['scorm'] = 'Paquete SCORM';
$string['set_mobile_number_instructions'] = 'Diríjase a la página del curso y haga clic en su nombre (Situado en la esquina superior derecha). Luego dar clic en "Editar perfil" y vaya hasta el final de la página. Coloque su número en el campo de teléfono móvil y luego clic en Actualizar.';
$string['sms'] = 'SMS';
