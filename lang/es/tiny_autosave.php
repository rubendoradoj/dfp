...
/**
 * Strings for component 'tiny_autosave', language 'es', version '4.2'.
 *
...
$string['privacy:metadata:database:tiny_autosave:userid'] = 'El ID de usuario de quien creó la sesión de autoguardado';
