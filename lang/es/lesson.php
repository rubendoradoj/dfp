...
$string['cachedef_overrides'] = 'Información de excepciones de usuarios y grupos';
...
$string['completiondetail:reachend'] = 'Completa la actividad hasta el final';
$string['completiondetail:timespent'] = 'Dedicar al menos {$a} en esta actividad';
...
$string['displaymode'] = 'Modo de vista';
...
$string['manageoverrides'] = 'Gestionar conflictos';
...
$string['selectreport'] = 'Seleccionar informe';
$string['sent'] = 'Enviado';
