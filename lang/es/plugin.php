...
/**
 * Strings for component 'plugin', language 'es', version '4.2'.
 *
 * @package     plugin
 * @category    string
...
$string['type_qbank'] = 'Complemento de banco de preguntas';
$string['type_qbank_plural'] = 'Complementos del banco de preguntas';
