...
/**
 * Strings for component 'auth_pop3', language 'es', version '4.2'.
 *
 * @package     auth_pop3
 * @category    string
...
$string['auth_pop3notinstalled'] = 'No se puede utilizar identificación POP3. El módulo IMAP de PHP no está instalado.';
