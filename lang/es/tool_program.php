...
/**
 * Strings for component 'tool_program', language 'es', version '4.2'.
 *
...
$string['associatedcertificationswitheditlinks'] = 'Certificaciones asociadas con enlaces para editar';
...
$string['conditionprogramcompletedalldescription'] = 'Usuarios que tiene el estado \'Completado\' en todos los siguientes programas: \'{$a->programname}\'';
$string['conditionprogramcompletedalldescriptionwithdate'] = 'Usuarios que tienen el estado \'Completado\' en todos los siguientes programas: \'{$a->programname}\'<br />
La fecha de finalización es igual o posterior a \'{$a->conditiondate}\'';
$string['conditionprogramcompletedanydescription'] = 'Usuarios que tienen el estado \'Completado\' en al menos uno de los siguientes programas: \'{$a->programname}\'';
$string['conditionprogramcompletedanydescriptionwithdate'] = 'Usuarios que tienen el estado \'Completado\' en al menos uno de los siguientes programas: \'{$a->programname}\'<br />
La fecha de finalización es igual o posterior a \'{$a->conditiondate}\'';
$string['conditionprogramcompleteddescription'] = 'Usuarios que tienen el estado de \'Completado\' en el programa \'{$a}\'';
$string['conditionprogramcompleteddescriptionwithdate'] = 'Usuarios que tienen el estado \'Completado\' en el programa \'{$a->programname}\'<br />
La fecha de finalización es igual o posterior a \'{$a->conditiondate}\'';
$string['conditionprogramnotcompleted'] = 'Programa no completado';
$string['conditionprogramnotcompleteddescription'] = 'Usuarios que no tienen el estado de \'Completado\' en el programa \'{$a}\'';
$string['conditionprogramoverdue'] = 'Programa atrasado';
$string['conditionprogramoverduedescription'] = 'Usuarios que tienen el estado \'Atrasado\' en el programa \'{$a}\'';
$string['conditionprogramoverduedescriptionwithdate'] = 'Usuarios que tienen el estado \'Atrasado\' en el programa \'{$a->nombre del programa}\'<br />
La fecha de vencimiento es igual o posterior a \'{$a->conditiondate}\'';
$string['conditionprogramsuspended'] = 'Programa suspendido';
$string['conditionprogramsuspendeddescription'] = 'Usuarios que tienen el estado \'Suspendido\' en el programa \'{$a}\'';
$string['conditionprogramsuspendeddescriptionwithdate'] = 'Usuarios que tienen el estado \'Suspendido\' en el programa \'{$a->programname}\'<br />
La fecha de suspensión es en o después de \'{$a->conditiondate}\'';
...
$string['confirmrecalculateprogress'] = 'Normalmente, si la configuración del programa se modifica después de que algunos estudiantes ya hayan completado el programa, éste permanece en el estado \'Completado\' incluso si ya no cumplen con los requisitos de finalización. Esta acción le permite restablecer y volver a calcular la finalización del programa. Esto no afectará ningún curso del programa ni certificaciones vinculadas.
<br />Esta acción no se puede deshacer. ¿Estás seguro de continuar?';
$string['confirmresetprogress'] = '¿Estás seguro de querer restablecer el progreso de \'{$a}\'? Esta acción:<br /><br />
<ul>
<li>restablecerá el programa</li>
<li>restablecerá todos los cursos que componen a este programa</li>
<li>eliminará todos los datos de completud</li>
</ul>
Esta acción puede demorar algunos minutos y no se puede deshacer.';
$string['confirmresetusersprogramusers'] = 'Para todos los usuarios seleccionados, esta acción:<br /><br />
<ul>
<li>restablecerá el programa</li>
<li>restablecerá todos los cursos que componen a este programa</li>
<li>eliminará todos los datos de completud</li>
...
$string['coursecompletiondisabled'] = 'No fueron establecidos los criterios de finalización de este curso. Los estudiantes lo verán como no completado en su tablero y es posible que no puedan completar el programa.';
$string['coursecriteriadisabled'] = 'El seguimiento de finalización de este curso está activado, pero no se han configurado criterios';
...
$string['criteriaall'] = 'Todos los programas seleccionados han sido completados';
$string['criteriaany'] = 'Al menos uno de los programas seleccionados está completo';
$string['criteriaany_help'] = 'Cuando un usuario ya ha completado un programa, completar el segundo no activa las acciones nuevamente';
$string['criteriaeach'] = 'Cada vez que un usuario completa cualquiera de los programas seleccionados';
$string['criteriaeach_help'] = 'Equivalente a crear múltiplees reglas, una por cada uno de los programas seleccionados';
...
$string['errornostudentsrolefound'] = 'No se han encontrado roles de estudiantes';
...
$string['fullprogramreport'] = 'Informe de programa completo';
$string['futureallocation'] = 'Asignaciones futuras';
$string['gotoprogram'] = 'Ir al programa';
$string['hidden'] = 'Oculto';
$string['hiddenfromlearners'] = 'Oculto para estudiantes';
...
$string['managedusersoverdue'] = 'Algunos miembros del equipo tienen programas pasados de fecha.';
...
$string['messageprovider:programuserallocated'] = 'Usuario asignado al programa';
$string['messageprovider:programuserdeallocated'] = 'Usuario desasignado del programa';
...
$string['notificationprogramcompleted'] = 'Hola {$a->userfullname},<br /><br />
Felicitaciones por completar el programa \'{$a->programname}\'!<br /><br />
Se pueden volver a visitar los cursos dentro del programa en cualquier momento. El programa completo se puede encontrar en la página \'Mis cursos\'.<br /><br />
{$a->sitename}<br />
{$a->siteurl}';
$string['notificationprogramuserallocated'] = 'Hola {$a->userfullname},<br /><br />
Te damos la bienvenida al programa \'{$a->programname}\', el cual podrás encontrar en la página \'Mis cursos\'.<br /><br />
{$a->duedatemsg}
{$a->sitename}<br />
{$a->siteurl}';
...
$string['outcomeallocationdescdate'] = 'Asignar usuarios al programa {$a->programname}<br />
{$a->startdatestr}<br />
Con usuarios suspendidos: {$a->suspendedusers}';
$string['outcomeallocationdesckeepdate'] = 'Quitar suspensión y dejar las fechas inicio/fin de programa existentes';
$string['outcomeallocationdesckeepstartdate'] = 'Mantener la fecha de inciio del programa por defecto';
$string['outcomeallocationdescstartdate'] = 'Fecha de inicio del programa: "{$a->startdate}"';
$string['outcomeallocationdescsuspendchangedate'] = 'Quitar suspensión y cambiar las fechas inicio/fin del programa';
$string['outcomeallocationdontmodify'] = 'No modificar asignaciones';
$string['outcomeallocationsuspendedusers'] = 'Con usuarios suspendidos';
$string['outcomeallocationsuspendedusers_help'] = 'Acción a realizar cuando los usuarios están ya asignados pero su asignación está suspendida o finalizada';
$string['outcomeallocationunsuspend'] = 'Quitar suspensión, dejar las fechas inicio/fin de programa existentes';
$string['outcomeallocationunsuspendchangedate'] = 'Quitar suspensión, cambiar las fechas inicio/fin de programa';
$string['outcomedeallocate'] = 'Desasignar al usuario del programa';
...
$string['outcomedeallocationdescriptionsuspend'] = 'Suspender las asignaciones de usuario existentes del programa "{$a}"';
$string['overdue'] = 'Atrasado';
$string['overdueprograms'] = 'Programas pasados de fecha';
...
$string['programdescription_help'] = 'La descripción del programa se muestra en la información del programa y en las páginas de portada.';
$string['programduedate'] = 'Fecha de vencimiento del programa';
$string['programfullname'] = 'Nombre del programa';
$string['programfullname_help'] = 'El nombre del programa se muestra en la página del listado de cursos.';
...
$string['programimage_help'] = 'La imagen del programa se muestra en la página de lista de cursos.';
$string['programinformation'] = 'Información del programa';
$string['programname'] = 'Nombre del programa';
$string['programnamewitheditlink'] = 'Nombre del programa con enlace para editar';
$string['programnamewithimage'] = 'Nombre del programa con imagen';
$string['programnamewithimageandeditlink'] = 'Nombre del programa con imagen y enlace para editar';
$string['programnamewithimageandviewlink'] = 'Nombre del programa con imagen y enlace para ver';
$string['programnamewithviewlink'] = 'Nombre del programa con enlace para ver';
$string['programparentsetname'] = 'Nombre del conjunto superior';
$string['programprogress'] = 'Progreso del programa';
$string['programprogressexport'] = '{$a} progreso del programa';
...
$string['programvisibility_help'] = 'Esta configuración determina si el programa se muestra en la lista de cursos del usuario o no.';
$string['progress'] = '{$a} completado';
$string['progressoverview'] = 'Descripción general del progreso';
$string['progressoverviewfor'] = 'Resumen del progreso de {$a}';
$string['progresspercent'] = 'Progreso';
$string['progressreport'] = 'Reporte de progreso';
$string['recalculateprogramcompletion'] = 'Re-calcular la completud del programa';
$string['recalculateprogramcompletion_help'] = 'La completud del programa será recalculada para todos los usuarios del programa. Por favor, tener en cuenta que si un usuario lo completó y se agrega nuevo contenido al programa, tal vez tenga que completarlo nuevamente. Esta acción conlleva algunos minutos para ser completada y no se puede deshacer.';
...
$string['usersrecalculationcompletion'] = 'Se recalculó la finalización del programa para {$a} usuario(s)';
