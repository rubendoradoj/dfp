...
/**
 * Strings for component 'tiny_filterws', language 'es', version '4.2'.
 *
...
$string['addfilterws'] = 'Añadir etiqueta de filtro de servicio web';
$string['apply'] = 'Aplicar';
$string['filteruseragent'] = '';
$string['insert'] = 'Insertar';
$string['insertfilterws'] = 'Insertar filtro de servicio web';
