...
/**
 * Strings for component 'format_onetopic', language 'es', version '4.2'.
 *
...
$string['aboutresource'] = 'Información del recurso';
...
$string['colorpicker'] = 'Selector de color';
...
$string['coursedisplay_multi'] = 'Encima de las pestañas';
$string['coursedisplay_single'] = 'Como pestaña';
$string['courseindex'] = 'Índice del curso';
$string['courseindex_help'] = 'Habilita o deshabilita la barra del <em>índice del curso</em>.
Esta opción solamente tiene sentido si el tema actual habilita la característica de <em>índice del curso</em> (normalmente así será).
Esta opción puede ser sobrescrita por cada curso.';
$string['creating_section'] = 'Creando el nuevo tema';
$string['cssbackground'] = 'Fondo';
$string['cssborder'] = 'Borde';
$string['csscolor'] = 'Color';
$string['cssdashed'] = 'Línea discontinua';
$string['cssdotted'] = 'Punteado';
$string['cssdouble'] = 'Doble';
$string['cssfont'] = 'Fuente';
$string['cssgroove'] = 'Surcos';
$string['csshidden'] = 'Oculto';
$string['cssinset'] = 'Interno';
$string['cssitalic'] = 'Itálica';
$string['cssnone'] = 'No';
$string['cssnormal'] = 'Normal';
$string['cssoblique'] = 'Oblicua';
$string['cssother'] = 'Otros estilos';
$string['cssoutset'] = 'Externo';
$string['cssradius'] = 'Radio';
$string['cssridge'] = 'Extruido';
$string['csssize'] = 'Tamaño';
$string['csssolid'] = 'Sólido';
$string['cssstyle'] = 'Estilo';
...
$string['cssunit'] = 'Unidad';
$string['cssweight'] = 'Grosor';
$string['cssweightbold'] = 'Negrilla';
$string['cssweightlighter'] = 'Ligera';
$string['currentsection'] = 'Este tema';
$string['defaultsectionsnavigation'] = 'Valor por defecto para la navegación de secciones';
$string['defaultsectionsnavigation_help'] = 'Valor por defecto a ser utilizado para definir el comportamiento de la funcionalidad "Usar navegación en secciones". Este valor puede ser sobrescrito por cada curso.';
...
$string['index'] = 'Inicio';
$string['invalidjsonstyles'] = 'La configuración de los estilos no es válida, falló por: {$a}';
$string['level'] = 'Nivel';
...
$string['privacy:metadata'] = 'El plugin de formato Onetopic no almacena datos personales.';
...
$string['settingsheaderstyles'] = 'Estilos';
...
$string['tablabeldefault'] = 'Por defecto {$a}';
$string['tablabeldisabled'] = 'Deshabilitada';
$string['tablabelhighlighted'] = 'Destacada';
$string['tablabelparent'] = 'Pestaña padre';
$string['tabstylebuttons_help'] = 'Clic en cada botón para configurar la apariencia de la pestaña en cada uno de los posibles estados.';
$string['tabstyleclear'] = 'Reiniciar estilos';
$string['tabstyles'] = 'Estilos de las pestañas';
$string['tabstyles_help'] = 'Estilos asignados para los diferentes estados de las pestañas.';
$string['tabstylesetactive'] = 'Activas';
$string['tabstylesetchildindex'] = 'Hija Inicio';
$string['tabstylesetchilds'] = 'Hijas';
$string['tabstylesetdefault'] = 'Por defecto';
$string['tabstylesetdisabled'] = 'Deshabilitadas';
$string['tabstylesethighlighted'] = 'Destacada';
$string['tabstylesethover'] = 'Sobre';
$string['tabstylesetparent'] = 'Padres';
$string['tabstylesset'] = 'Asignar';
$string['tabstylestitle'] = 'Estilos';
...
$string['templetetopic_list'] = 'Sí, usar el resumen como plantilla y listar los recursos no referenciados';
$string['templetetopic_not'] = 'No, mostrar por defecto';
$string['templetetopic_single'] = 'Sí, usar el resumen como una plantilla';
$string['usecourseindexsite'] = 'Usar el valor por defecto del sitio';
