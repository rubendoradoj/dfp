...
/**
 * Strings for component 'atto_snippet', language 'es', version '4.2'.
 *
...
$string['browse'] = 'Mirar';
$string['bundle'] = 'Conjunto';
$string['cancel'] = 'Cancelar';
$string['chooseinsert'] = '¿Qué quiere insertar Usted?';
$string['createsnippet'] = 'Crear snippet (retazo)';
$string['defaults'] = 'Valores por defecto del snippet';
$string['dialogtitle'] = 'Ingresar Preferencias';
$string['fieldsheader'] = 'Introduzca detalles para:';
...
$string['pluginname'] = 'Snippet Atto (Retazo Atto)';
$string['presets'] = 'Preconfiguraciones';
$string['privacy:metadata'] = 'El plugin de Atto Snippet (Retazo Atto) no almacena ningún dato personal.';
...
$string['snippetname'] = 'Nombre del Snippet (retazo)';
$string['snippetpageheading'] = '{$a}';
$string['snippets'] = 'Snippets (retazos)';
$string['snippetversion'] = 'Versión del Snippet';
