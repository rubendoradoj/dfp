...
$string['agedigitalconsentverification_desc'] = 'Habilita la verificación de la edad digital de consentimiento antes de mostrar la página de alta para auto-registrar usuarios. Esto protege a su sitio de menores de edad que se podrían apuntar sin el consentimiento de sus padres o tutores. Se proporcionan para más ayuda detalles de  <a target="_blank" href="{$a}">contacto de asistencia</a>';
...
$string['availabletoanyone'] = 'Disponible para cualquiera que visite el sitio';
$string['availabletoauthenticated'] = 'Sólo para usuarios autenticados';
...
$string['blockprotected'] = 'Las instancias de bloque {$a} están protegidas.';
...
$string['blockunprotected'] = 'Las instancias de bloque {$a} no están protegidas';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Para purgar las demás cachés tras el corte de tráfico de usuarios por nuevo código:
...
Se recomienda hacer estas purgas aisladamente, con un espacio entre comandos, para reducir los picos de carga del servidor de red.';
...
$string['cliupgrademaintenancenotrequired'] = 'Esta actualización NO supondrá modo de mantenimiento a los usuarios.';
$string['cliupgrademaintenancerequired'] = 'Esta actualización SÍ supondrá modo de mantenimiento a los usuarios.';
...
$string['cliupgradesetlock'] = 'La actualización se ha bloqueado sólo para ejecución CLI';
$string['cliupgradeunsetlock'] = 'Se ha quitado el bloqueo de actualización de ejecución CLI existente.';
$string['cliyesnoprompt'] = 'escriba s (para sí) o n (para no)';
$string['close'] = 'Cerrar';
$string['cohort_customfield'] = 'Campos personalizados de cohorte';
...
$string['configallusersaresitestudents'] = 'Para actividades de la página principal del sitio, ¿deberían TODOS los usuarios ser considerados como estudiantes? Si la respuesta es "Sí", cualquier usuario con una cuenta podrá participar como estudiante en estas actividades. Si la respuesta es "No", sólo los usuarios que ya participan en al menos un curso podrán participar en las actividades de la página principal. Sólo los administradores y profesores especialmente asignados pueden actuar como profesores en las actividades de la página principal del sitio.';
...
$string['configautolangusercreation'] = 'Si está activado, cuando una cuenta de un usuario es creada automáticamente en su primer acceso (usando LDAP o autenticación OAuth2), el idioma del navegador será utilizado para fijar el idioma del perfil. De otra forma, se utilizará el idioma del sitio para el perfil del usuario.';
...
$string['configduration_high'] = 'Este valor es demasiado alto. El máximo es {$a}.';
$string['configduration_low'] = 'Este valor es demasiado bajo. El valor mínimo es {$a}.';
...
$string['configemaildkimselector'] = 'El selector DKIM es arbitrario y sus registros DNS deben coincidir con él.';
...
$string['configforcelogin'] = 'Normalmente la página principal del sitio y los listados de cursos (pero no los cursos) pueden ser leídos por cualquier visitante sin necesidad de identificarse. Si desea forzar a los visitantes a identificarse antes de poder hacer CUALQUIER COSA en el sitio, debería activar esta opción.';
...
$string['configfrontpage'] = 'Los elementos seleccionados arriba se mostrarán en la página principal del sitio.';
...
$string['configfullnamedisplay'] = 'Esta opción define cómo se verán los nombres cuando se muestren completos. Por defecto, "idioma", redirige a la cadena de caracteres "mostrarnombrecompleto (fullnamedisplay)" en el idioma a escoger. Algunos idiomas siguen un método de visualización del nombre diferente.

Para la mayoría de los sitios que usen un solo idioma, el ajuste más eficiente es el valor por defecto ("Nombre + Apellido"), pero puede elegir ocultar los apellidos. Los marcadores de posición que se pueden utilizar son: nombre, apellido, nombrefonético, apellidofonético, segundonombre, nombrealternativo (firstname, lastname, firstnamephonetic, lastnamephonetic, middlename, alternatename).';
...
$string['configrecaptchapublickey'] = 'Cadena de caracteres (Clave del sitio) usados para mostrar el elemento reCAPTCHA en el formulario de acceso. Las claves ReCAPTCHA se obtienen en <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configservicespage'] = 'Introduzca la URL de la página de servicios y soporte o déjela en blanco para enlazar a los servicios Moodle en moodle.com. El enlace sólo se muestra a administradores del sitio.';
...
$string['configsmtpauthtype'] = 'Esto configura el tipo de autenticación a usar en el servidor SMTP.';
...
$string['configsmtpoauthservice'] = 'Seleccione el servicio OAuth 2 configurado para comunicarse con el servidor SMTP. Si el servicio no existe aún, tendrá que crearlo. Nota: necesitará configurar el tipo SMTP Auth como XOAUTH2.';
...
$string['configsupportavailability'] = 'Determina quién tiene acceso para contactar soporte del sitio desde el pie.';
$string['configsupportemail'] = 'Si el SMTP está configurado en este sitio y no se ha establecido una página de soporte, esta dirección de correo electrónico recibirá los mensajes enviados a través del formulario de soporte. Si el envío falla, la dirección de correo electrónico se mostrará a los usuarios conectados.';
$string['configsupportname'] = 'El nombre de la persona u otra entidad que proporciona asistencia a través del formulario o la página de asistencia.';
$string['configsupportpage'] = 'Se proporcionará un enlace a esta página para que los usuarios se pongan en contacto con el soporte del sitio. Si el campo se deja en blanco, se proporcionará un enlace a un formulario de soporte en su lugar.';
...
$string['confirmdeletecomments'] = '¿Seguro que quiere eliminar el/los comentario(s) seleccionados?';
$string['confirmed'] = 'Confirmado';
$string['contactsitesupport'] = 'Contactar con el soporte del sitio';
...
$string['coursecreationguide'] = 'URL de guía de creación de curso';
$string['coursecreationguide_help'] = 'Define la ruta a una guía rápida con vídeos cortos y consejos generales para crear cursos. Se muestra un enlace a la guía en la página "Mis cursos" cuando no hay cursos para mostrar. Sólo verán el enlace los usuarios con permisos de creación de cursos.';
...
$string['cron_keepalive'] = 'Mantener activo';
$string['cron_keepalive_desc'] = 'El tiempo para mantener tareas adicionales en cola. Este ajuste es útil para asegurar que el cron siempre esté ejecutándose. Si usa lanzadores de tareas dedicados, entonces debería ajustar este valor a 0. De lo contrario recomendamos ajustarlo a un valor similar al de su límite de concurrencia de tareas adhoc. Evite valores mayores. El valor máximo es 15 minutos.';
...
$string['debugtemplateinfo'] = 'Mostrar informacion de plantilla';
$string['debugtemplateinfo_desc'] = 'Si se habilita, las plantillas usadas para renderizar se muestran como comentarios en el HTML de la página. Úsese sólo para debug temporal, ya que produce errores de validación de HTML y podría romper algunos scripts de página.';
...
$string['disableplugin'] = 'Deshabilitar {$a}';
...
$string['enabledashboard'] = 'Habilitar Panel';
$string['enabledashboard_help'] = 'El panel muestra la línea de tiempo, el calendario y los elementos a los que se accedió recientemente de forma predeterminada. Puede configurar un panel predeterminado diferente para todos y permitir que los usuarios personalicen su propio panel. Si está deshabilitado, debe configurar \'Página de inicio para usuarios\' en un valor que no sea panel.';
...
$string['enablepdfexportfont'] = 'Habilitar fuentes PDF';
$string['enablepdfexportfont_desc'] = 'Si su sitio tiene cursos en diferentes idiomas que necesiten otros fonts en los archivos PDF generados, usted puede proporcionar la opción para configurar el font en las configuraciones del curso. Usted necesita especificar los fonts disponibles en $CFG->pdfexportfont en config.php.';
$string['enableplugin'] = 'Habilitar {$a}';
...
$string['enroladminnewcourse'] = 'Matricular automáticamente al administrador en nuevos cursos';
$string['enroladminnewcourse_help'] = 'Cuando un administrador añade un nuevo curso, ¿debería matricularse automáticamente y asignársele el rol de creador en los nuevos cursos?';
...
$string['entitytasklog'] = 'Registro de tareas';
...
$string['environmentmariadbwrongdbtype'] = '<code>$CFG->dbtype</code> erróneo: debe de cambiarlo en su fichero config.php  desde \'<code>mysql</code>\' a \'<code>mariadb</code>\'.';
...
$string['favicon_desc'] = 'Archivo favicon que se mostrará como icono del sitio. Se mostrará un favicon de Moodle si no se personaliza.';
...
$string['frontpageloggedin'] = 'Elementos de la página principal al iniciar sesión';
...
$string['iplookupinfo'] = 'Por defecto Moodle utiliza el servidor gratuito en línea NetGeo (The Internet Geographic Database) para buscar la ubicación de las direcciones IP. Esta base de datos ya no se mantiene, y puede devolver información errónea.
Se recomienda instalar una copia local de la base de datos GeoLite2 City, desde MaxMind.<br />
Si se da una clave Google Maps API V3, se verá la localización mediante Google Maps. Necesita una cuenta de Google y solicitar una clave Google Maps API. Si no se da clave Google Maps API V3, la localización de la dirección IP se mostrará mediante OpenStreetMap.';
...
$string['navshowfrontpagemods_help'] = 'Si se habilita, las actividades de la página de portada se mostrarán en la navegación debajo de las páginas del sitio. Este ajuste sólo es aplicable a los temas basados en el Clásico (Classic).';
...
$string['navsortmycoursessort'] = 'Ordenar mis cursos en el bloque de navegación';
$string['navsortmycoursessort_help'] = '¿Deberían mostrarse los cursos en Administración del sitio > Cursos > Administrar cursos y categorías o alfabéticamente según la configuración del curso? Este ajuste sólo se aplica a los temas basados en Classic.';
$string['never'] = 'Nunca';
...
$string['noteunneededblocks'] = 'Nota: Los bloques configurados para mostrarse no aparecerán en el menú "Añadir un bloque" de un curso si están especificados en la configuración del tema "Bloques innecesarios".';
...
$string['profilefieldmaxlength_help'] = 'Para utilizar este campo en el ajuste \'Mostrar identidad de usuario\', el límite debe ser de 255 caracteres o menos.';
...
$string['profilevisible_help'] = '* No visible: para datos privados que solo pueden ver los administradores y gerentes
* Visible para el usuario: para datos privados que solo el usuario y los administradores pueden ver
* Visible para usuarios, profesores y administradores: para datos privados que solo pueden ver el usuario, los administradores y los profesores (en el perfil del curso)
* Visible a todos';
...
$string['proxyfixunsafe'] = 'Fijar las llamadas sin proxy';
$string['proxyhost'] = 'Host proxy';
$string['proxylogunsafe'] = 'Registrar las llamadas sin proxy';
...
$string['replacefrontsearch'] = 'Utilizada para la busqueda de la página principal';
...
$string['searchmaxtopresults'] = 'Máximo de resultados más altos';
$string['searchmaxtopresults_desc'] = 'El número máximo de resultados mejor clasificados que se mostrarán encima de los resultados de búsqueda para el contenido del curso, los cursos y los usuarios.';
...
$string['searchteacherroles'] = 'Roles de profesor';
$string['searchteacherroles_desc'] = 'Seleccione todos los roles que hacen que los usuarios con el ranking de roles estén más arriba en los resultados de búsqueda.';
$string['searchtopresults'] = 'Mejores resultados';
...
$string['servicespage'] = 'Enlace a "Servicios y soporte"';
...
$string['sitesectionhelp'] = 'Si se selecciona, se mostrará una sección de tema en la página principal del sitio.';
...
$string['supportemailsubject'] = 'Solicitud de soporte del sitio - {$a}';
$string['supportname'] = 'Nombre del soporte';
$string['supportpage'] = 'Enlace a página de soporte del sitio';
...
$string['task_dbreads'] = 'La base de datos lee';
$string['task_dbstats'] = 'Base de datos';
$string['task_dbwrites'] = 'La base de datos escribe';
$string['task_duration'] = 'Duración';
$string['task_endtime'] = 'Hora de finalización';
...
$string['task_logoutput'] = 'Salida de la tarea';
...
$string['task_status'] = 'Estado de la tarea';
$string['task_status_desc'] = 'La tarea \'{$a->name}\' está {$a->status}. Para consultar los detalles visite {$a->class}{$a->extradescription} en <a href="{$a->gotourl}">Tareas programadas</a>.';
...
$string['tasklockcleanuptask'] = 'Limpiar los metadatos de las tareas ad hoc';
...
$string['testoutgoingmailconf_fromemail'] = 'Nombre de usuario o correo electrónico del remitente';
$string['testoutgoingmailconf_fromemail_help'] = 'Este campo emula el envío de un mensaje desde ese usuario, pero la cabedera "De:" utilizada en el correo electrónico que se envíe realmente depende de otros ajustes como por ejemplo allowedemaildomains';
$string['testoutgoingmailconf_fromemail_invalid'] = 'Nombre de usuario o correo electrónico del remitente no válido. Debe tener un formato de correo electrónico válido o un nombre de usuario existente en Moodle.';
$string['testoutgoingmailconf_message'] = 'Este es un mensaje de prueba para confirmar que ha configurado correctamente el correo saliente de su sitio. Enviado: {$a}';
...
$string['testoutgoingmailconf_subject'] = '{$a->site}: mensaje de prueba. {$a->additional} Enviado: {$a->time}';
$string['testoutgoingmailconf_subjectadditional'] = 'Tema adicional';
