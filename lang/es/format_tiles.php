...
$string['experimentalfeature'] = 'Característica experimental';
...
$string['photoguidance_desc'] = '<p>Sube una foto en formato <strong>horizontal</strong>. El ancho debe ser aproximadamente 1,35 veces la altura. P.ej. 270 ancho x 200 alto quedaría bien. No necesita ser exacto.</p> <p>Las fotos en formato vertical no coincidirán con la forma del mosaico. Las imágenes o archivos grandes se reducirán y comprimirán si es necesario, después de cargarlos.</p>';
...
$string['registermissingemail'] = 'Por favor complete su dirección Email (Usted ha seleccionado "Si" para Emails debajo)';
$string['registerpickemailpref'] = 'Por favor elija su preferencia de Email';
$string['registerpolicyagreedlinktext'] = 'Acuerdo de Procesamiento de Datos y Política de Privacidad';
$string['registrationdeferred'] = 'Gracias. Estamos tratando de registrar su plugin (esto aun no está completo).';
...
$string['restoreincorrectsections'] = 'Error: No se puede completar porque el curso orígen contiene secciones numeradas incorrectamente (por ejemplo el número de sección ({$a->sectionnum}) es mayor que el máximo permitido ({$a->maxallowed}).  Intente excluir o eliminar secciones con números grandes.';
...
$string['transparenttitleadjustments_desc'] = 'En mosaicos de fotos con fondos de título transparentes, dependiendo de su tema, es posible que desee ajustarlos para asegurarse de que las líneas transparentes del título no se superpongan cuando se ajusten. Tenga en cuenta que estos también varían un poco entre los navegadores. Valores sugeridos para Chrome: temas basados en Boost y Clean: 30.5 y 4 | Adaptable: 32 y 4 | Mooove: 32 y 2 | Remui: 32 y 2.5';
