...
/**
 * Strings for component 'theme_more', language 'es', version '4.2'.
 *
 * @package     theme_more
 * @category    string
...
$string['invertdesc'] = 'Intercambiar texto y fondo de la barra de navegación de la parte superior de la página entre blanco y negro.';
...
$string['pluginname'] = 'More (Más)';
$string['privacy:metadata'] = 'El tema More (Más) no almacena ningún dato personal acerca de ningún usuario.';
