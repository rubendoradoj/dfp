...
$string['auth_joomla_auto_sell_description'] = 'Crear/actualizar/eliminar cursos en la tienda Joomla cuando se hace en Moodle <br>';
$string['auth_joomla_connection_method'] = 'Método de conexión<br>';
...
$string['auth_joomla_parent_role_id'] = 'Rol padre';
$string['auth_joomla_parent_role_id_description'] = 'Seleccionar rol padre';
$string['auth_joomla_redirectless_sso'] = 'Usar SSO sin redireccionamiento';
$string['auth_joomla_redirectless_sso_description'] = 'Use SSO sin redirección. Requiere cURL';
$string['auth_joomla_single_log_out'] = 'Salida única';
$string['auth_joomla_single_log_out_description'] = 'Salir de Joomla cuando salga de Moodle';
$string['auth_joomla_sync_to_joomla'] = 'Sincronizar usuarios con Joomla';
$string['auth_joomla_sync_to_joomla_description'] = 'Sincroniza nuevos usuarios y actualizaciones de perfiles con Joomla';
$string['auth_joomla_url'] = 'Joomla URL<br>';
$string['auth_joomla_url_desc'] = 'URL del servidor Joomla<br>';
$string['auth_joomla_use_kunena_forums'] = 'Utilice los foros de Kunena';
$string['auth_joomla_use_kunena_forums_description'] = 'Sincronice los foros del curso con los foros de Kunena en Joomla. Solo Joomla 1.6+';
