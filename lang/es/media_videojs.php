...
/**
 * Strings for component 'media_videojs', language 'es', version '4.2'.
 *
...
$string['configaudioextensions'] = 'Una lista separada por comas de extensiones de archivos de audio compatibles. VideoJS intentará usar el reproductor de vídeo nativo del navegador cuando esté disponible o la funcionalidad nativa de VideoJS.';
...
$string['configvideoextensions'] = 'Una lista separada por comas de extensiones de archivos de vídeo compatibles. VideoJS intentará usar el reproductor de vídeo nativo del navegador cuando esté disponible.';
...
$string['pluginname_help'] = 'Un contenedor de JavaScript para archivos de vídeo reproducidos por el reproductor de vídeo nativo del navegador. (La compatibilidad con el formato depende del navegador).';
