...
/**
 * Strings for component 'assignment', language 'es', version '4.2'.
 *
 * @package     assignment
 * @category    string
...
$string['assignmentneedsupgrade'] = 'La actividad antigua "Tarea 2.2" ha sido eliminada.';
...
$string['modulenameplural'] = 'Tareas 2.2 (Deshabilitado)';
...
$string['privacy:metadata:assignment_submissions:grade'] = 'El valor de calificación otorgado para el envío de la tarea.';
$string['privacy:metadata:assignment_submissions:mailed'] = 'El estado de notificación enviado del envío de la tarea.';
$string['privacy:metadata:assignment_submissions:numfiles'] = 'El número máximo de archivos permitidos para el envío de la tarea.';
$string['privacy:metadata:assignment_submissions:submissioncomment'] = 'El comentario al envío que acompaña al envío de la tarea.';
$string['privacy:metadata:assignment_submissions:teacher'] = 'El ID de usuario del profesor que califica el envío de la tarea.';
$string['privacy:metadata:assignment_submissions:timecreated'] = 'La fecha/hora de creación del envío de la tarea.';
