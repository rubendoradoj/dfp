...
$string['cohort:configurecustomfields'] = 'Configurar campos personalizados de cohorte';
...
$string['confirmaddadmins'] = '¿Seguro que quiere añadir a los siguientes usuarios al listado de administradores del sitio?';
$string['confirmdeladmin'] = '¿Realmente desea eliminar al usuario <strong>{$a}</strong> de la lista de administradores del sitio?';
$string['confirmremoveadmins'] = '¿Seguro que quiere eliminar a los siguientes usuarios del listado de administradores del sitio?';
...
$string['eventrolecreated'] = 'Rol creador';
