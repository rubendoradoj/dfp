...
$page = new admin_settingpage('theme_space_block9', get_string('settingsblock9', 'theme_space'));

$name = 'theme_space/displayblock9';
$title = get_string('turnon', 'theme_space');
$description = get_string('displayblock9_desc', 'theme_space');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #9</span>', $description, $default);
$page->add($setting);

$name = 'theme_space/displayhrblock9';
...
$name = 'theme_space/block9introtitle';
...
$name = 'theme_space/block9introcontent';
...
$name = 'theme_space/block9footercontent';
