...
$page = new admin_settingpage('theme_space_block21', get_string('settingsblock21', 'theme_space'));

$name = 'theme_space/displayblock21';
$title = get_string('turnon', 'theme_space');
$description = get_string('displayblock21_desc', 'theme_space');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #21</span>', $description, $default);
$page->add($setting);

$name = 'theme_space/displayhrblock21';
...
$name = 'theme_space/block21introtitle';
...
$name = 'theme_space/block21introcontent';
...
$name = 'theme_space/block21htmlcontent';
...
$name = 'theme_space/block21footercontent';
