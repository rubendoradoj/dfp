...
$string['topbareditmode_desc'] = '<img src="{$a->siteurl}/theme/space/doc/topbar-editmode.png" class="mt-2 rounded" style="max-height: 100px; width: auto; max-width: 100%;" alt="Edit mode" />';
$string['turnoffdashboardlink'] = 'Turn off Dashboard Link (User Menu)';
$string['turnoffdashboardlink_desc'] = '<p>You can turn off Dashboard Link inside the User menu.</p><img src="{$a->siteurl}/theme/space/doc/user-menu-dashboard.png" class="mt-2 rounded" style="max-height: 300px; width: auto; max-width: 100%;" alt="Dashboard Link" />';
...
<div class="w-100 mt-2"><img src="{$a->siteurl}/theme/space/doc/course-simple-list.png" class="img-fluid rounded w-100" style="max-width: 500px;" alt="Space Moodle Theme" /></div>';
...
$string['courselangbadge_desc'] = '<p>(Course - Settings - Appearance - Force Language)</p><img src="{$a->siteurl}/theme/space/doc/course-lang-badge.jpg" class="img-fluid mt-2 rounded" width="100%" alt="Course Simple List" />';
...
$string['hcoursecard_desc'] = 'Customize course card e.g Get access label. <br /><img src="{$a->siteurl}/theme/space/doc/course-card.jpg" class="img-fluid rounded mt-3 w-100" style="max-width: 500px;" alt="space Moodle Theme" />';
...
$string['courseprogressbar_desc'] = 'Course progress bar displays on the course index sidebar<br /><div class="w-100 mt-2"><img src="{$a->siteurl}/theme/space/doc/course-progress.png" class="img-fluid rounded w-100" style="max-width: 500px;" alt="space Moodle Theme" /></div>';
...
$string['setdashboardlayout_desc'] = '<img src="{$a->siteurl}/theme/space/doc/dashboard-layout.jpg" class="img-fluid rounded my-3 w-100" alt="space Moodle Theme" />';
...
$string['hintro'] = '<img src="{$a->siteurl}/theme/space/doc/theme-icon.svg" class="img-fluid rounded my-3" width="80" height="80" alt="space Moodle Theme" /><div class="lead-3">Space for Moodle 4.2</div>';
$string['hintro_desc'] = '
...
<br /><img src="{$a->siteurl}/theme/space/doc/sidebar-labels.png" width="w-100 rounded" style="max-height:150px;" />';
...
$string['secnavgroupitem_desc'] = 'For users with capabilities like moodle/course:managegroups. <br /><img src="{$a->siteurl}/theme/space/doc/secondary-nav-course-tmpl.png" width="w-100 rounded" style="max-height:150px;" />';
