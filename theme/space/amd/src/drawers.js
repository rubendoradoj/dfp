...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_space/drawers:show}
     * @property {String} drawerShown See {@link event:theme_space/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_space/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_space/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_space/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_space/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_space/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_space/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_space/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_space/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_space/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_space/drawers:hidden',
    };
     ...
     * @returns {module:theme_space/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_space/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_space/drawers:close');
     ...
     *
     * @param {module:theme_space/drawers} comparisonInstance
     */
