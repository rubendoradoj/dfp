...
// Hidden sidebar.
if (theme_space_get_setting('turnoffsidebarincourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
// Moodle 4.x.
if (theme_space_get_setting('hidecourseindexnav') == true) {
    $hidecourseindexnav = true;
} else {
    $hidecourseindexnav = false;
}

if (theme_space_get_setting('hidecourseindexnav') == false) {
...
echo $OUTPUT->render_from_template('theme_space/tmpl-incourse', $templatecontext);
