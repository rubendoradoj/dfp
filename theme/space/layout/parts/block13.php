...
$block13textalign = theme_space_get_setting('block13textalign');
$block13class = theme_space_get_setting('block13class');

$block13titlecolor = theme_space_get_setting('block13titlecolor');
$block13titlesize = theme_space_get_setting('block13titlesize');
$block13titleweight = theme_space_get_setting('block13titleweight');
