...
$block2titlecolor = theme_space_get_setting('block2herotitlecolor');
$block2herotitlesize = theme_space_get_setting('block2herotitlesize');
$block2titleweight = theme_space_get_setting('block2herotitleweight');
...
$block2herotitle = format_text(theme_space_get_setting("block2herotitle"), FORMAT_HTML, array('noclean' => true));
$block2herosubheading = format_text(theme_space_get_setting("block2herosubheading"), FORMAT_HTML, array('noclean' => true));
$block2herocaption = format_text(theme_space_get_setting("block2herocaption"), FORMAT_HTML, array('noclean' => true));
$block2herocss = theme_space_get_setting("block2herocss");
...
if (theme_space_get_setting('block2fw') == '1') {
