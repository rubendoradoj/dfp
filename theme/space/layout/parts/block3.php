...
$block3titlecolor = theme_space_get_setting('block3herotitlecolor');
$block3herotitlesize = theme_space_get_setting('block3herotitlesize');
$block3titleweight = theme_space_get_setting('block3herotitleweight');
$block3count = theme_space_get_setting('block3count');
$block3wrapperbg = theme_space_get_setting('block3wrapperbg');
...
$block3herotitle = format_text(theme_space_get_setting("block3herotitle"), FORMAT_HTML, array('noclean' => true));
$block3herosubheading = format_text(theme_space_get_setting("block3herosubheading"), FORMAT_HTML, array('noclean' => true));
$block3herocaption = format_text(theme_space_get_setting("block3herocaption"), FORMAT_HTML, array('noclean' => true));
$block3herocss = theme_space_get_setting("block3herocss");
...
if (theme_space_get_setting('block3fw') == '1') {
