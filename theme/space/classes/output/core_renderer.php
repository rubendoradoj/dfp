...
use theme_config;
use get_string;
use theme_space\util\course;
use theme_space\util\user;
...
class core_renderer extends \core_renderer {
    ...
    public function render_lang_menu_login() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_space/lang_menu_login', $context);
            }
        }
    }
            ...
            if ($completion->is_enabled()) {
                ...
                if (get_config('theme_space', 'courseprogressbar') == 1) {
                    $progressbar = '<div class="rui-course-progresschart mr-2">' .
                        $this->render_from_template('theme_space/progress-chart', $templatedata) .
                        '</div>';
    ...
    protected function course_summary($courseid = 0, $content = '') {
        ...
        $output .= "MI MEDIA";//format_text($desc, FORMAT_HTML);
    ...
    public function mainsidebarmenu() {
        ...
        if (get_config('theme_space', 'isitemonsitehome') == 1) {
            ...
            if (!empty(get_config('theme_space', 'possitehome'))) {
        ...
        if (get_config('theme_space', 'isitemondashboard') == 1) {
            ...
            if (!empty(get_config('theme_space', 'posdashboard'))) {
        ...
        if (get_config('theme_space', 'isitemoncalendar') == 1) {
            ...
            if (!empty(get_config('theme_space', 'poscalendar'))) {
        ...
        if (get_config('theme_space', 'isitemoncontentbank') == 1) {
            ...
            if (!empty(get_config('theme_space', 'poscontentbank'))) {
        ...
        if (get_config('theme_space', 'isitemonprivatefiles') == 1) {
            ...
            if (!empty(get_config('theme_space', 'posprivatefiles'))) {
        ...
        if (get_config('theme_space', 'isitemonmycourses') == 1) {
            ...
            if (!empty(get_config('theme_space', 'posmycourses'))) {
                $posmycourses = $theme->settings->posmycourses;
            } else {
                $posmycourses = '6';
            }
        }
        if (get_config('theme_space', 'iscustomitem1on') == 1) {
            $iscustomitem1on = true;

            if (get_config('theme_space', 'poscustomitem1') != null) {
                $poscustomitem1 = $theme->settings->poscustomitem1;
            }
            if (get_config('theme_space', 'labelcustomitem1') != null) {
                $labelcustomitem1 = format_text(($theme->settings->labelcustomitem1), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_space', 'iconcustomitem1') != null) {
            ...
            if (get_config('theme_space', 'urlcustomitem1') != null) {
                $urlcustomitem1 = $theme->settings->urlcustomitem1;
            }
        }

        if (get_config('theme_space', 'iscustomitem2on') == 1) {
            $iscustomitem2on = true;

            if (get_config('theme_space', 'poscustomitem2') != null) {
                $poscustomitem2 = $theme->settings->poscustomitem2;
            }
            if (get_config('theme_space', 'labelcustomitem2') != null) {
                $labelcustomitem2 = format_text(($theme->settings->labelcustomitem2), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_space', 'iconcustomitem2') != null) {
            ...
            if (get_config('theme_space', 'urlcustomitem2') != null) {
                $urlcustomitem2 = $theme->settings->urlcustomitem2;
            }
        }

        if (get_config('theme_space', 'iscustomitem3on') == 1) {
            $iscustomitem3on = true;

            if (get_config('theme_space', 'poscustomitem3') != null) {
                $poscustomitem3 = $theme->settings->poscustomitem3;
            }
            if (get_config('theme_space', 'labelcustomitem3') != null) {
                $labelcustomitem3 = format_text(($theme->settings->labelcustomitem3), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_space', 'iconcustomitem3') != null) {
            ...
            if (get_config('theme_space', 'urlcustomitem3') != null) {
                $urlcustomitem3 = $theme->settings->urlcustomitem3;
            }
        }

        if (get_config('theme_space', 'iscustomitem4on') == 1) {
            $iscustomitem4on = true;

            if (get_config('theme_space', 'poscustomitem4') != null) {
                $poscustomitem4 = $theme->settings->poscustomitem4;
            }
            if (get_config('theme_space', 'labelcustomitem4') != null) {
                $labelcustomitem4 = format_text(($theme->settings->labelcustomitem4), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_space', 'iconcustomitem4') != null) {
            ...
            if (get_config('theme_space', 'urlcustomitem4') != null) {
                $urlcustomitem4 = $theme->settings->urlcustomitem4;
            }
        }

        if (get_config('theme_space', 'iscustomitem5on') == 1) {
            $iscustomitem5on = true;

            if (get_config('theme_space', 'poscustomitem5') != null) {
                $poscustomitem5 = $theme->settings->poscustomitem5;
            }
            if (get_config('theme_space', 'labelcustomitem5') != null) {
                $labelcustomitem5 = format_text(($theme->settings->labelcustomitem5), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_space', 'iconcustomitem5') != null) {
            ...
            if (get_config('theme_space', 'urlcustomitem5') != null) {
    ...
    public function space_allcourseslink() {
        ...
        $allcoursetxt = format_text(
            theme_space_get_setting('stringallcourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses_heading() {
        ...
        $detailstxt = format_text(
            theme_space_get_setting('stringdetails'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses_heading_text() {
        ...
        $txt = format_text(
            theme_space_get_setting('stringmycourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses() {
        ...
        $nomycoursestxt = format_text(
            theme_space_get_setting('stringnocourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function moremenu_custom_items () {
        ...
        $theme = \theme_config::load('space');
        $html = '';
        $secnavcount = theme_space_get_setting('secnavitemscount');
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                $secnav->title = theme_space_get_setting("secnavcustomnavlabel" . $i);

                $url = theme_space_get_setting("secnavcustomnavurl" . $i);
                $courseid = $COURSE->id;
                $newurl = str_replace("{{courseID}}", $courseid, $url);
                
                // User role restriction.
                $selectrole = theme_space_get_setting("secnavuserrole" . $i);
                ...
                $secnav->url = $newurl;
                $html .= $this->render_from_template('theme_space/custom_sec_nav_item', $secnav);
            }
        }
        return $html;
    }
