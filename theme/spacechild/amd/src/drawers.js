 ...
 *
 * @module     theme_spacechild/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_spacechild/drawers:show}
     * @property {String} drawerShown See {@link event:theme_spacechild/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_spacechild/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_spacechild/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_spacechild/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_spacechild/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_spacechild/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_spacechild/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_spacechild/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_spacechild/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_spacechild/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_spacechild/drawers:hidden',
    };
     ...
     * @returns {module:theme_spacechild/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_spacechild/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_spacechild/drawers:close');
     ...
     *
     * @param {module:theme_spacechild/drawers} comparisonInstance
     */
