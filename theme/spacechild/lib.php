 ...
 * @return string
 */
function theme_spacechild_get_setting($setting, $format = false) {
 ...
 */
function theme_spacechild_css_tree_post_processor($tree, $theme) {
    debugging('theme_spacechild_css_tree_post_processor() is deprecated. Required' .
        'prefixes for Bootstrap are now in theme/spacechild/scss/moodle/prefixes.scss');
    $prefixer = new theme_spacechild\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return string
 */
function theme_spacechild_get_extra_scss($theme) {
    $content = '';

    // Sets the login background image.
    // Check login layout, only layout #1 has background image.
    $loginlayout = theme_spacechild_get_setting('setloginlayout');
 ...
 * @return bool
 */
function theme_spacechild_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        ...
        if ($filearea === 'hvp') {
            return theme_spacechild_serve_hvp_css($args[1], $theme);
        }
        if ($filearea === 'favicon') {
 ...
 */
function theme_spacechild_setting_file_url($setting, $filearea, $theme) {
    global $CFG;

    $component = 'theme_spacechild';
    $itemid = 0;
 ...
 * @return string
 */
function theme_spacechild_get_main_scss_content($theme) {
    global $CFG;
    ...
    if ($filename == 'default.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/spacechild/scss/preset/default.scss');
    } else if ($filename == 'plain.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/spacechild/scss/preset/plain.scss');
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_spacechild', 'preset', 0, '/', $filename))) {
 ...
 */
function theme_spacechild_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/spacechild/style/moodle.css');
}
 ...
 * @return array
 */
function theme_spacechild_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string.
 */
function theme_spacechild_get_course_guest_access_hint($courseid) {
    global $CFG;
 ...
 * @return string.
 */
function theme_spacechild_get_course_information_banners() {
    ...
    if (get_config('theme_spacechild', 'showhintcoursehidden') == 1
            && $allowtoshowhint == true
            && $PAGE->has_set_url()
        ...
        $html .= $OUTPUT->render_from_template('theme_spacechild/course-hint-hidden', $templatecontext);
    }
    ...
    // intended.
    if (get_config('theme_spacechild', 'showhintcourseguestaccess') == 1
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_spacechild/course-hint-guestaccess', $templatecontext);
    }
    ...
    if (get_config('theme_spacechild', 'showhintcourseselfenrol') == 1
            && $allowtoshowhint == true
            && $PAGE->has_set_url()
            && $PAGE->url->compare(new moodle_url('/course/view.php'), URL_MATCH_BASE)
            && $COURSE->visible == true) {
        ...
        if (!empty($selfenrolinstances) &&
            ...
            if ($selfenrolmentpossiblecurrently == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartcurrently', 'theme_spacechild');
            } else if ($selfenrolmentpossiblefuture == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartfuture', 'theme_spacechild');
            }
            ...
            foreach ($selfenrolinstances as $selfenrolinstanceid => $selfenrolinstanceobject) {
                ...
                if ($selfenrolinstanceobject->unrestrictedness == 'unlimited') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolunlimited', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'until') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenroluntil', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'from') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfrom', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name,
                                    'from' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'since') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsince', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name,
                                    'since' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'fromuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfromuntil', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'from' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'sinceuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsinceuntil', 'theme_spacechild',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'since' => userdate($selfenrolinstanceobject->startdate)));
                }
            ...
            // Render template and add it to HTML code.
            $html .= $OUTPUT->render_from_template('theme_spacechild/course-hint-selfenrol', $templatecontext);
        }
    }
    ...
    if (get_config('theme_spacechild', 'showswitchedroleincourse') == 1
            && is_role_switched($COURSE->id) ) {
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_spacechild/course-hint-switchedrole', $templatecontext);
    }
 ...
 * @throws dml_exception
 */
function theme_spacechild_serve_hvp_css($filename, $theme) {
    global $CFG, $PAGE;
    ...
    $settings = new \theme_spacechild\util\theme_settings();
    $content = $settings->hvpcss;

    $md5content = md5($content);
    $md5stored = get_config('theme_spacechild', 'hvpccssmd5');
