...
$THEME->name = 'spacechild';
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->editor_scss = ['editor'];
$THEME->usefallback = true;
$THEME->scss = function ($theme) {
    return theme_spacechild_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_spacechild_get_extra_scss';
$THEME->prescsscallback = 'theme_spacechild_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_spacechild_get_precompiled_css';
$THEME->yuicssmodules = [];
