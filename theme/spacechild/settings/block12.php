...
$page = new admin_settingpage('theme_spacechild_block12', get_string('settingsblock12', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock12';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock12_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #12</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock12';
...
$name = 'theme_spacechild/block12class';
...
$name = 'theme_spacechild/block12introtitle';
...
$name = 'theme_spacechild/block12introcontent';
...
$name = 'theme_spacechild/block12htmlcontent';
...
$name = 'theme_spacechild/block12footercontent';
