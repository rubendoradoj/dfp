...
$page = new admin_settingpage('theme_spacechild_block13', get_string('settingsblock13', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock13';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock13_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #13</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock13';
...
$name = 'theme_spacechild/block13class';
...
$name = 'theme_spacechild/block13textalign';
$title = get_string('block13textalign', 'theme_spacechild');
$description = get_string('block13textalign_desc', 'theme_spacechild');
$options = [];
...
$name = 'theme_spacechild/block13titlesize';
...
$name = 'theme_spacechild/block13titlecolor';
...
$name = 'theme_spacechild/block13titleweight';
...
$name = 'theme_spacechild/block13introtitle';
...
$name = 'theme_spacechild/block13introcontent';
...
$name = 'theme_spacechild/block13htmlcontent';
...
$name = 'theme_spacechild/block13footercontent';
...
$fileid = 'block13bg';
$name = 'theme_spacechild/block13bg';
$title = get_string('block13bg', 'theme_spacechild');
$description = get_string('block13bg_desc', 'theme_spacechild');
$opts = array('accepted_types' => array('.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'), 'maxfiles' => 1);
$setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/block13customcss';
$title = get_string('block13customcss', 'theme_spacechild');
$description = get_string('block13customcss_desc', 'theme_spacechild');
$default = '';
$setting = new admin_setting_configtextarea($name, $title, $description, $default);
$page->add($setting);
