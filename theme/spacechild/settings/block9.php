...
$page = new admin_settingpage('theme_spacechild_block9', get_string('settingsblock9', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock9';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock9_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #9</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock9';
...
$name = 'theme_spacechild/block9class';
...
$name = 'theme_spacechild/block9introtitle';
...
$name = 'theme_spacechild/block9introcontent';
...
$name = 'theme_spacechild/block9htmlcontent';
...
$name = 'theme_spacechild/block9footercontent';
