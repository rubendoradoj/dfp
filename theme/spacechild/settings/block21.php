...
$page = new admin_settingpage('theme_spacechild_block21', get_string('settingsblock21', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock21';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock21_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #21</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock21';
...
$name = 'theme_spacechild/block21class';
...
$name = 'theme_spacechild/block21introtitle';
...
$name = 'theme_spacechild/block21introcontent';
...
$name = 'theme_spacechild/block21htmlcontent';
...
$name = 'theme_spacechild/block21footercontent';
