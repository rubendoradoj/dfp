...
$page = new admin_settingpage('theme_spacechild_block6', get_string('settingsblock6', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock6';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock6_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #6</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock6';
...
$name = 'theme_spacechild/block6class';
...
$name = 'theme_spacechild/block6introtitle';
...
$name = 'theme_spacechild/block6introcontent';
...
$name = 'theme_spacechild/block6htmlcontent';
...
$name = 'theme_spacechild/block6footercontent';
