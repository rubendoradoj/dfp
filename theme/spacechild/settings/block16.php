...
$page = new admin_settingpage('theme_spacechild_block16', get_string('settingsblock16', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock16';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock16_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #16</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock16';
...
$name = 'theme_spacechild/block16class';
...
$name = 'theme_spacechild/block16introtitle';
...
$name = 'theme_spacechild/block16introcontent';
...
$name = 'theme_spacechild/block16htmlcontent';
...
$name = 'theme_spacechild/block16footercontent';
...
$fileid = 'block16bg';
$name = 'theme_spacechild/block16bg';
...
$name = 'theme_spacechild/block16customcss';
