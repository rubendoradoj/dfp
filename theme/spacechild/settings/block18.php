...
$page = new admin_settingpage('theme_spacechild_block18', get_string('settingsblock18', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock18';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock18_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #18</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock18';
...
$name = 'theme_spacechild/block18class';
...
$name = 'theme_spacechild/block18introtitle';
...
$name = 'theme_spacechild/block18introcontent';
...
$name = 'theme_spacechild/block18htmlcontent';
$title = get_string('blockhtmlcontent', 'theme_spacechild');
$description = get_string('block18htmlcontent_desc', 'theme_spacechild');
...
$name = 'theme_spacechild/block18footercontent';
