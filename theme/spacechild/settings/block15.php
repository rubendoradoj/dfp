...
$page = new admin_settingpage('theme_spacechild_block15', get_string('settingsblock15', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock15';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock15_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #15</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock15';
...
$name = 'theme_spacechild/block15class';
...
$name = 'theme_spacechild/block15introtitle';
...
$name = 'theme_spacechild/block15introcontent';
...
$name = 'theme_spacechild/block15htmlcontent';
...
<img src="https://assets.rosea.io/spacechild/demo/course-smpl-img.jpg" alt="">
</figure>
</a>
...
<img src="https://assets.rosea.io/spacechild/demo/avatar.png" class="rui-card-avatar" alt="System Administrator">
</a>
</div>
...
$name = 'theme_spacechild/block15footercontent';
...
$fileid = 'block15bg';
$name = 'theme_spacechild/block15bg';
$title = get_string('blockbg', 'theme_spacechild');
$description = get_string('blockbg_desc', 'theme_spacechild');
$opts = array('accepted_types' => array('.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'), 'maxfiles' => 1);
$setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_spacechild/block15customcss';
$title = get_string('blockcustomcss', 'theme_spacechild');
$description = get_string('blockcustomcss_desc', 'theme_spacechild');
$default = '';
$setting = new admin_setting_configtextarea($name, $title, $description, $default);
$page->add($setting);
