...
$page = new admin_settingpage('theme_spacechild_block8', get_string('settingsblock8', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock8';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock8_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #8</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock8';
...
$name = 'theme_spacechild/block8class';
...
$name = 'theme_spacechild/block8introtitle';
...
$name = 'theme_spacechild/block8introcontent';
...
$name = 'theme_spacechild/block8htmlcontent';
...
$name = 'theme_spacechild/block8footercontent';
