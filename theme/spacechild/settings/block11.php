...
$page = new admin_settingpage('theme_spacechild_block11', get_string('settingsblock11', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock11';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock11_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #11</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock11';
...
$name = 'theme_spacechild/block11class';
...
$name = 'theme_spacechild/block11introtitle';
...
$name = 'theme_spacechild/block11introcontent';
...
$name = 'theme_spacechild/block11htmlcontent';
...
$name = 'theme_spacechild/block11footercontent';
