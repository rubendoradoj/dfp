...
$page = new admin_settingpage('theme_spacechild_block22', get_string('settingsblock22', 'theme_spacechild'));

$name = 'theme_spacechild/displayblock22';
$title = get_string('turnon', 'theme_spacechild');
$description = get_string('displayblock22_desc', 'theme_spacechild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #22</span>', $description, $default);
$page->add($setting);

$name = 'theme_spacechild/displayhrblock22';
...
$name = 'theme_spacechild/block22class';
...
$name = 'theme_spacechild/block22introtitle';
...
$name = 'theme_spacechild/block22introcontent';
...
$name = 'theme_spacechild/block22htmlcontent';
...
$name = 'theme_spacechild/block22footercontent';
