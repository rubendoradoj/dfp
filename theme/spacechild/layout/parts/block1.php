...
$block1wrapperalign = theme_spacechild_get_setting('block1wrapperalign');
$block1titlecolor = theme_spacechild_get_setting('block1herotitlecolor');
$block1herotitlesize = theme_spacechild_get_setting('block1herotitlesize');
$block1titleweight = theme_spacechild_get_setting('block1herotitleweight');
$block1count = theme_spacechild_get_setting('block1count');
$block1class = theme_spacechild_get_setting('block1class');

if (!empty(theme_spacechild_get_setting('block1sliderinterval'))) {
    $block1sliderinterval = theme_spacechild_get_setting('block1sliderinterval');
} else {
...
if (theme_spacechild_get_setting('showblock1sliderwrapper') == '1') {
...
if (theme_spacechild_get_setting('block1fw') == '1') {
...
for ($i = 1; $i <= $block1count; $i++) {
    ...
    $title = format_text(theme_spacechild_get_setting("block1slidetitle" . $i), FORMAT_HTML, array('noclean' => true));
    $subheading = format_text(theme_spacechild_get_setting("block1slidesubheading" . $i), FORMAT_HTML, array('noclean' => true));
    $caption = format_text(theme_spacechild_get_setting("block1slidecaption" . $i), FORMAT_HTML, array('noclean' => true));
    $css = theme_spacechild_get_setting("block1slidecss" . $i);
