...
$block3wrapperalign = theme_spacechild_get_setting('block3wrapperalign');
$block3titlecolor = theme_spacechild_get_setting('block3herotitlecolor');
$block3herotitlesize = theme_spacechild_get_setting('block3herotitlesize');
$block3titleweight = theme_spacechild_get_setting('block3herotitleweight');
$block3count = theme_spacechild_get_setting('block3count');
$block3wrapperbg = theme_spacechild_get_setting('block3wrapperbg');
$block3class = theme_spacechild_get_setting('block3class');
$block3introtitle = format_text(theme_spacechild_get_setting('block3introtitle'), FORMAT_HTML, array('noclean' => true));
$block3introcontent = format_text(theme_spacechild_get_setting('block3introcontent'), FORMAT_HTML, array('noclean' => true));
$block3html = format_text(theme_spacechild_get_setting('block3htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block3footer = format_text(theme_spacechild_get_setting('block3footercontent'), FORMAT_HTML, array('noclean' => true));

$block3herotitle = format_text(theme_spacechild_get_setting("block3herotitle"), FORMAT_HTML, array('noclean' => true));
$block3herosubheading = format_text(theme_spacechild_get_setting("block3herosubheading"), FORMAT_HTML, array('noclean' => true));
$block3herocaption = format_text(theme_spacechild_get_setting("block3herocaption"), FORMAT_HTML, array('noclean' => true));
$block3herocss = theme_spacechild_get_setting("block3herocss");
...
if (theme_spacechild_get_setting('showblock3wrapper') == '1') {
...
if (theme_spacechild_get_setting('block3fw') == '1') {
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock3") == '1') {
