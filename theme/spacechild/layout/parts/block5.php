...
$block5introtitle = format_text(theme_spacechild_get_setting('block5introtitle'), FORMAT_HTML, array('noclean' => true));
$block5introcontent = format_text(theme_spacechild_get_setting('block5introcontent'), FORMAT_HTML, array('noclean' => true));
$block5html = format_text(theme_spacechild_get_setting('block5htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block5footer = format_text(theme_spacechild_get_setting('block5footercontent'), FORMAT_HTML, array('noclean' => true));
$block5count = theme_spacechild_get_setting('block5count');
$block5slidesperrow = theme_spacechild_get_setting('block5slidesperrow');
$block5class = theme_spacechild_get_setting('block5class');
...
for ($i = 1; $i <= $block5count; $i++) {
    ...
    $title = format_text(theme_spacechild_get_setting("block5itemtitle" . $i), FORMAT_HTML, array('noclean' => true));
    $url = theme_spacechild_get_setting("block5itemurl" . $i);
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock5") == '1') {
