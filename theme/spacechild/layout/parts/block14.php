...
// Variables..
$block14introtitle = format_text(theme_spacechild_get_setting('block14introtitle'), FORMAT_HTML, array('noclean' => true));
$block14introcontent = format_text(theme_spacechild_get_setting('block14introcontent'), FORMAT_HTML, array('noclean' => true));
$block14html = format_text(theme_spacechild_get_setting('block14htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block14footer = format_text(theme_spacechild_get_setting('block14footercontent'), FORMAT_HTML, array('noclean' => true));
$block14css = theme_spacechild_get_setting('block14customcss');
$block14img = $PAGE->theme->setting_file_url("block14bg", "block14bg");
$block14textalign = theme_spacechild_get_setting('block14textalign');
$block14class = theme_spacechild_get_setting('block14class');

$block14titlecolor = theme_spacechild_get_setting('block14titlecolor');
$block14titlesize = theme_spacechild_get_setting('block14titlesize');
$block14titleweight = theme_spacechild_get_setting('block14titleweight');
...
echo '</div>';
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock14") == '1') {
