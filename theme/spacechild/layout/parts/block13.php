...
// Variables..
$block13introtitle = format_text(theme_spacechild_get_setting('block13introtitle'), FORMAT_HTML, array('noclean' => true));
$block13introcontent = format_text(theme_spacechild_get_setting('block13introcontent'), FORMAT_HTML, array('noclean' => true));
$block13html = format_text(theme_spacechild_get_setting('block13htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block13footer = format_text(theme_spacechild_get_setting('block13footercontent'), FORMAT_HTML, array('noclean' => true));
$block13css = theme_spacechild_get_setting('block13customcss');
$block13img = $PAGE->theme->setting_file_url("block13bg", "block13bg");
$block13textalign = theme_spacechild_get_setting('block13textalign');
$block13class = theme_spacechild_get_setting('block13class');

$block13titlecolor = theme_spacechild_get_setting('block13titlecolor');
$block13titlesize = theme_spacechild_get_setting('block13titlesize');
$block13titleweight = theme_spacechild_get_setting('block13titleweight');
...
echo '</div>';
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock13") == '1') {
