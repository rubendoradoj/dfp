...
// Variables..
$block19introtitle = format_text(theme_spacechild_get_setting('block19introtitle'), FORMAT_HTML, array('noclean' => true));
$block19introcontent = format_text(theme_spacechild_get_setting('block19introcontent'), FORMAT_HTML, array('noclean' => true));
$block19html = format_text(theme_spacechild_get_setting('block19htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block19footer = format_text(theme_spacechild_get_setting('block19footercontent'), FORMAT_HTML, array('noclean' => true));
$block19css = theme_spacechild_get_setting('block19customcss');
$block19img = $PAGE->theme->setting_file_url("block19bg", "block19bg");
$block19textalign = theme_spacechild_get_setting('block19textalign');
$block19class = theme_spacechild_get_setting('block19class');

$block19titlecolor = theme_spacechild_get_setting('block19titlecolor');
$block19titlesize = theme_spacechild_get_setting('block19titlesize');
$block19titleweight = theme_spacechild_get_setting('block19titleweight');
...
echo '</div>';
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock19") == '1') {
