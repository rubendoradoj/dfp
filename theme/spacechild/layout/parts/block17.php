...
$block17introtitle = format_text(theme_spacechild_get_setting('block17introtitle'), FORMAT_HTML, array('noclean' => true));
$block17introcontent = format_text(theme_spacechild_get_setting('block17introcontent'), FORMAT_HTML, array('noclean' => true));
$block17html = format_text(theme_spacechild_get_setting('block17htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block17footer = format_text(theme_spacechild_get_setting('block17footercontent'), FORMAT_HTML, array('noclean' => true));
$block17class = theme_spacechild_get_setting('block17class');
$block17img = $PAGE->theme->setting_file_url("block17bg", "block17bg");
$block17css = theme_spacechild_get_setting('block17customcss');
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock17") == '1') {
