...
$block16introtitle = format_text(theme_spacechild_get_setting('block16introtitle'), FORMAT_HTML, array('noclean' => true));
$block16introcontent = format_text(theme_spacechild_get_setting('block16introcontent'), FORMAT_HTML, array('noclean' => true));
$block16html = format_text(theme_spacechild_get_setting('block16htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block16footer = format_text(theme_spacechild_get_setting('block16footercontent'), FORMAT_HTML, array('noclean' => true));
$block16class = theme_spacechild_get_setting('block16class');
$block16img = $PAGE->theme->setting_file_url("block16bg", "block16bg");
$block16css = theme_spacechild_get_setting('block16customcss');
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock16") == '1') {
