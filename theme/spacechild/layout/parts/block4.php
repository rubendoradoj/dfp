...
$block4introtitle = format_text(theme_spacechild_get_setting('block4introtitle'), FORMAT_HTML, array('noclean' => true));
$block4introcontent = format_text(theme_spacechild_get_setting('block4introcontent'), FORMAT_HTML, array('noclean' => true));
$block4html = format_text(theme_spacechild_get_setting('block4htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block4footer = format_text(theme_spacechild_get_setting('block4footercontent'), FORMAT_HTML, array('noclean' => true));
$block4class = theme_spacechild_get_setting('block4class');
...
$block4count = theme_spacechild_get_setting('block4count');
echo '<div class="wrapper-md mt-6">';
echo '<div class="accordion" id="block4Accordion">';
for ($i = 1; $i <= $block4count; $i++) {

    $q = format_text(theme_spacechild_get_setting("block4question" . $i), FORMAT_HTML, array('noclean' => true));
    $a = format_text(theme_spacechild_get_setting("block4answer" . $i), FORMAT_HTML, array('noclean' => true));
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock4") == '1') {
