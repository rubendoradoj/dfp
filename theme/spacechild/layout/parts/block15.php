...
$block15introtitle = format_text(theme_spacechild_get_setting('block15introtitle'), FORMAT_HTML, array('noclean' => true));
$block15introcontent = format_text(theme_spacechild_get_setting('block15introcontent'), FORMAT_HTML, array('noclean' => true));
$block15html = format_text(theme_spacechild_get_setting('block15htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block15footer = format_text(theme_spacechild_get_setting('block15footercontent'), FORMAT_HTML, array('noclean' => true));
$block15class = theme_spacechild_get_setting('block15class');
$block15img = $PAGE->theme->setting_file_url("block15bg", "block15bg");
$block15css = theme_spacechild_get_setting('block15customcss');
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock15") == '1') {
