...
$block2wrapperalign = theme_spacechild_get_setting('block2wrapperalign');
$block2titlecolor = theme_spacechild_get_setting('block2herotitlecolor');
$block2herotitlesize = theme_spacechild_get_setting('block2herotitlesize');
$block2titleweight = theme_spacechild_get_setting('block2herotitleweight');
$block2count = theme_spacechild_get_setting('block2count');
$block2class = theme_spacechild_get_setting('block2class');
$block2introtitle = format_text(theme_spacechild_get_setting('block2introtitle'), FORMAT_HTML, array('noclean' => true));
$block2introcontent = format_text(theme_spacechild_get_setting('block2introcontent'), FORMAT_HTML, array('noclean' => true));
$block2html = format_text(theme_spacechild_get_setting('block2htmlcontent'), FORMAT_HTML, array('noclean' => true));
$block2footer = format_text(theme_spacechild_get_setting('block2footercontent'), FORMAT_HTML, array('noclean' => true));

$block2herotitle = format_text(theme_spacechild_get_setting("block2herotitle"), FORMAT_HTML, array('noclean' => true));
$block2herosubheading = format_text(theme_spacechild_get_setting("block2herosubheading"), FORMAT_HTML, array('noclean' => true));
$block2herocaption = format_text(theme_spacechild_get_setting("block2herocaption"), FORMAT_HTML, array('noclean' => true));
$block2herocss = theme_spacechild_get_setting("block2herocss");
...
if (theme_spacechild_get_setting('showblock2wrapper') == '1') {
...
if (theme_spacechild_get_setting('block2fw') == '1') {
...
echo '</div>';
if (theme_spacechild_get_setting("displayhrblock2") == '1') {
    echo '<hr class="rui-block-hr" />';
}
echo '<!-- End Block #2 -->';

echo '<script src="theme/spacechild/addons/vidbg/vidbg.js"></script>';
