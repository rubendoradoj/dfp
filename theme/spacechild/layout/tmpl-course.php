...
user_preference_allow_ajax_update('mycourses-on', PARAM_ALPHA);
user_preference_allow_ajax_update('mycourses-hidden-on', PARAM_ALPHA);
user_preference_allow_ajax_update('mycourses-inprogress-on', PARAM_ALPHA);
...
// Hidden sidebar.
if (theme_spacechild_get_setting('turnoffsidebarcourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
// Moodle 4.x.
if (theme_spacechild_get_setting('hidecourseindexnav') == true) {
    $hidecourseindexnav = true;
} else {
    $hidecourseindexnav = false;
}

if (theme_spacechild_get_setting('hidecourseindexnav') == false) {
...
$couseimagesettings = theme_spacechild_get_setting('setcourseimage');
...
$coursepageinformationbannershtml = theme_spacechild_get_course_information_banners();
...
echo $OUTPUT->render_from_template('theme_spacechild/tmpl-course', $templatecontext);
