...
/**
 * Privacy Subsystem implementation for theme_spacechild.
 *
...
namespace theme_spacechild\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($darkmodepref)) {
            $preferencestring = get_string('privacy:darkmodeoff', 'theme_spacechild');
            if ($darkmodepref !== null) {
                $preferencestring = get_string('privacy:darkmodeon', 'theme_spacechild');
            }
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_spacechild');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_spacechild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_spacechild',
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_spacechild');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_spacechild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_spacechild',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_spacechild');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_spacechild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_spacechild',
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:rightdrawerclosed', 'theme_spacechild');
            if ($rightdraweropennpref !== null) {
                $preferencestring = get_string('privacy:rightdraweropen', 'theme_spacechild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_spacechild',
                self::DRAWER_OPEN_NAV,
