...
class core_renderer extends \core_renderer {
    ...
    public function standard_end_of_body_html() {
        ...
        $theme = theme_config::load('spacechild');
    ...
    public function theme_part($name, $vars = array()) {
        ...
        if (file_exists($candidate1)) {
            ...
            $candidate = $CFG->dirroot . theme_spacechild_theme_dir() . '/spacechild/layout/parts/' . $element;
        }
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_spacechild/lang_menu', $context);
            }
        }
    }
    ...
    public function render_lang_menu_login() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_spacechild/lang_menu_login', $context);
            }
        }
    }
    ...
    protected function courseprogress($course) {
        global $USER;
        $theme = \theme_config::load('spacechild');
        ...
        if (get_class($courseformat) != 'format_tiles') {
            ...
            if ($completion->is_enabled()) {
                ...
                if (get_config('theme_spacechild', 'courseprogressbar') == 1) {
                    $progressbar = '<div class="rui-course-progresschart mr-2">' .
                        $this->render_from_template('theme_spacechild/progress-chart', $templatedata) .
                        '</div>';
    ...
    protected function course_summary($courseid = 0, $content = '') {
        ...
        $media_by_course = \core_course\external\course_media::get_media_by_course($iscourseid, $USER->id);
        $media_DFPol_by_course = \core_course\external\course_media::get_media_dfpool_by_course($COURSE->id);

        $output .= html_writer::start_div('badge-sm badge-success my-1 mr-1');
        $output .= "Mi media: ".$media_by_course." VS Media DFPOL: ".$media_DFPol_by_course;
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/spacechild/pix";
    }
    ...
    public function breadcrumbs() {
        ...
        $html = $this->render_from_template('theme_spacechild/breadcrumbs', $header);
    ...
    public function full_header() {
        ...
        $html .= $this->render_from_template('theme_spacechild/header', $header);
    ...
    public function simple_header() {
        ...
        if ($this->page->pagelayout == 'admin') {
            $html .= $this->render_from_template('theme_spacechild/header_admin', $header);
        }
    ...
    public function mainsidebarmenu() {
        ...
        if (get_config('theme_spacechild', 'isitemonsitehome') == 1) {
            $isitemonsitehome = true;

            if (!empty(get_config('theme_spacechild', 'possitehome'))) {
                $possitehome = $theme->settings->possitehome;
            } else {
                $possitehome = '1';
            }
        }
        if (get_config('theme_spacechild', 'isitemondashboard') == 1) {
            $isitemondashboard = true;

            if (!empty(get_config('theme_spacechild', 'posdashboard'))) {
                $posdashboard = $theme->settings->posdashboard;
            } else {
                $posdashboard = '2';
            }
        }
        if (get_config('theme_spacechild', 'isitemoncalendar') == 1) {
            $isitemoncalendar = true;

            if (!empty(get_config('theme_spacechild', 'poscalendar'))) {
                $poscalendar = $theme->settings->poscalendar;
            } else {
                $poscalendar = '3';
            }
        }
        if (get_config('theme_spacechild', 'isitemoncontentbank') == 1) {
            $isitemoncontentbank = true;

            if (!empty(get_config('theme_spacechild', 'poscontentbank'))) {
                $poscontentbank = $theme->settings->poscontentbank;
            } else {
                $poscontentbank = '4';
            }
        }
        if (get_config('theme_spacechild', 'isitemonprivatefiles') == 1) {
            $isitemonprivatefiles = true;

            if (!empty(get_config('theme_spacechild', 'posprivatefiles'))) {
                $posprivatefiles = $theme->settings->posprivatefiles;
            } else {
                $posprivatefiles = '5';
            }
        }
        if (get_config('theme_spacechild', 'isitemonmycourses') == 1) {
            $isitemonmycourses = true;

            if (!empty(get_config('theme_spacechild', 'posmycourses'))) {
                $posmycourses = $theme->settings->posmycourses;
            } else {
                $posmycourses = '6';
            }
        }
        if (get_config('theme_spacechild', 'iscustomitem1on') == 1) {
            $iscustomitem1on = true;

            if (get_config('theme_spacechild', 'poscustomitem1') != null) {
                $poscustomitem1 = $theme->settings->poscustomitem1;
            }
            if (get_config('theme_spacechild', 'labelcustomitem1') != null) {
                $labelcustomitem1 = format_text(($theme->settings->labelcustomitem1), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_spacechild', 'iconcustomitem1') != null) {
            ...
            if (get_config('theme_spacechild', 'urlcustomitem1') != null) {
                $urlcustomitem1 = $theme->settings->urlcustomitem1;
            }
        }

        if (get_config('theme_spacechild', 'iscustomitem2on') == 1) {
            $iscustomitem2on = true;

            if (get_config('theme_spacechild', 'poscustomitem2') != null) {
                $poscustomitem2 = $theme->settings->poscustomitem2;
            }
            if (get_config('theme_spacechild', 'labelcustomitem2') != null) {
                $labelcustomitem2 = format_text(($theme->settings->labelcustomitem2), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_spacechild', 'iconcustomitem2') != null) {
            ...
            if (get_config('theme_spacechild', 'urlcustomitem2') != null) {
                $urlcustomitem2 = $theme->settings->urlcustomitem2;
            }
        }

        if (get_config('theme_spacechild', 'iscustomitem3on') == 1) {
            $iscustomitem3on = true;

            if (get_config('theme_spacechild', 'poscustomitem3') != null) {
                $poscustomitem3 = $theme->settings->poscustomitem3;
            }
            if (get_config('theme_spacechild', 'labelcustomitem3') != null) {
                $labelcustomitem3 = format_text(($theme->settings->labelcustomitem3), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_spacechild', 'iconcustomitem3') != null) {
            ...
            if (get_config('theme_spacechild', 'urlcustomitem3') != null) {
                $urlcustomitem3 = $theme->settings->urlcustomitem3;
            }
        }

        if (get_config('theme_spacechild', 'iscustomitem4on') == 1) {
            $iscustomitem4on = true;

            if (get_config('theme_spacechild', 'poscustomitem4') != null) {
                $poscustomitem4 = $theme->settings->poscustomitem4;
            }
            if (get_config('theme_spacechild', 'labelcustomitem4') != null) {
                $labelcustomitem4 = format_text(($theme->settings->labelcustomitem4), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_spacechild', 'iconcustomitem4') != null) {
            ...
            if (get_config('theme_spacechild', 'urlcustomitem4') != null) {
                $urlcustomitem4 = $theme->settings->urlcustomitem4;
            }
        }

        if (get_config('theme_spacechild', 'iscustomitem5on') == 1) {
            $iscustomitem5on = true;

            if (get_config('theme_spacechild', 'poscustomitem5') != null) {
                $poscustomitem5 = $theme->settings->poscustomitem5;
            }
            if (get_config('theme_spacechild', 'labelcustomitem5') != null) {
                $labelcustomitem5 = format_text(($theme->settings->labelcustomitem5), FORMAT_HTML, array('noclean' => true));
            }

            if (get_config('theme_spacechild', 'iconcustomitem5') != null) {
            ...
            if (get_config('theme_spacechild', 'urlcustomitem5') != null) {
    ...
    public function adminheaderlink() {
        ...
        if (is_siteadmin() || $hasadminlink) {
            ...
            return $this->render_from_template('theme_spacechild/btn-admin', $adminlinkheaderlinktmpl);
        }
    }
    ...
    public function space_allcourseslink() {
        ...
        $allcoursetxt = format_text(
            theme_spacechild_get_setting('stringallcourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses_heading() {
        ...
        $detailstxt = format_text(
            theme_spacechild_get_setting('stringdetails'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses_heading_text() {
        ...
        $txt = format_text(
            theme_spacechild_get_setting('stringmycourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function space_mycourses() {
        ...
        $nomycoursestxt = format_text(
            theme_spacechild_get_setting('stringnocourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        $am->add(
            '<div class="dropdown-user-wrapper"><div class="dropdown-user">' . $usertextcontents  . '</div>'
                ...
                . '<div class="dropdown-user-meta"><span class="badge-xs badge-sq badge-warning flex-wrap p-2 px-3">' .
                $usermeta . '</span></div>'
    ...
    public function heading($text, $level = 2, $classes = null, $id = null) {
        ...
        return html_writer::tag('h' . $level, $text, array('id' => $id, 'class' => 'rui-main-content-title--h' . $level . ' rui-title-container page-header-headings ' . renderer_base::prepare_classes($classes)));
    }
    ...
    public function moremenu_custom_items () {
        ...
        $theme = \theme_config::load('spacechild');
        $html = '';
        $secnavcount = theme_spacechild_get_setting('secnavitemscount');
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                $secnav->title = theme_spacechild_get_setting("secnavcustomnavlabel" . $i);

                $url = theme_spacechild_get_setting("secnavcustomnavurl" . $i);
                $courseid = $COURSE->id;
                $newurl = str_replace("{{courseID}}", $courseid, $url);
                
                // User role restriction.
                $selectrole = theme_spacechild_get_setting("secnavuserrole" . $i);
                ...
                $secnav->url = $newurl;
                $html .= $this->render_from_template('theme_spacechild/custom_sec_nav_item', $secnav);
            }
        }
        return $html;
    }
