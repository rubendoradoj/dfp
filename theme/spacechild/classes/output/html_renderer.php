...
class html_renderer extends \plugin_renderer_base {
    ...
    public function page_header() {
        ...
        if (empty($this->theme)) {
            $this->theme = theme_config::load('spacechild');
        }
    ...
    protected function image_header($fixednavbar = false) {
        ...
        foreach ($images as $image) {
            if (!empty($settings->$image)) {
                ...
                if ($CFG->branch >= 33) {
                    $template->$image = $this->image_url($image, 'theme_spacechild');
                } else {
                    $template->$image = $this->pix_url($image, 'theme_spacechild');
                }
            }
        }
        ...
        return $this->render_from_template('theme_spacechild/imageheading', $template);
    }
    ...
    protected function navigation_menu($fixednavbar = false) {
        ...
        return $this->render_from_template('theme_spacechild/navigation', $template);
    }

    /**
     * Render the social icons shown in the page footer.
     */
    public function spacechild_socialicons() {
        global $CFG;
        $content = '';
        ...
        return $this->render_from_template('theme_spacechild/socialicons', $template);
    }
    ...
    public function languagemenu() {
        ...
        if ($haslangmenu) {
            ...
            return $this->render_from_template('theme_spacechild/language', $langmenu);
        }
    }
    ...
    public function footer() {
        ...
        $template->socialicons = $this->spacechild_socialicons();
        ...
        return $this->render_from_template('theme_spacechild/footer', $template);
    }
