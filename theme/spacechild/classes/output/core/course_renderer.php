...
namespace theme_spacechild\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $stringaccess = format_text(theme_spacechild_get_setting('stringaccess'), FORMAT_HTML, array('noclean' => true));
        ...
        if ($theme->settings->courselistview == 1) {
            return $this->render_from_template('theme_spacechild/custom_courselist', $data);
        } else {
            return $this->render_from_template('theme_spacechild/custom_coursecard', $data);
        }
    }
