...
* remove folder theme/spacechild/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/spacechild/scss/bootstrap
* comment out left: 0; from .popover {} in scss/bootstrap/_popover.scss.
* In RTL mode this prevents popovers from showing and it is not required in LTR mode.
* comment out this line in theme/spacechild/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/spacechild/amd/src/bootstrap (including the subfolder)
* Moodle core includes the popper.js library, make sure each of the new Bootstrap js files
includes the 'core/popper' library instead of 'popper.js'. For version 4.5.0 these files were:
* tooltip.js and dropdown.js
